...
export default class WFGroupPickupViewBase extends Vue {
	 ...
	 * @memberof WFGroupPickupViewBase
	 */
	public viewtag: string = 'b05c9353d499f973106e6ed4dde58074';
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'WFGroupPickupView')){
                    return;
                }
...
<style lang='less'>
@import './wfgroup-pickup-view.less';
</style>