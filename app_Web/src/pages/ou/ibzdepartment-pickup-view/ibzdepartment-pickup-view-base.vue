...
<div class="view-container depickupview ibzdepartment-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzdepartmentpickupview"></app-studioaction>
...
export default class IBZDepartmentPickupViewBase extends Vue {
	 ...
	 * @memberof IBZDepartmentPickupViewBase
	 */
	public viewtag: string = '10dd7f45f36233049c4af9ca417089f5';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzdepartment-pickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzdepartment-pickup-view',tag:this.viewtag,srfkey:this.context.ibzdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
...
<style lang='less'>
@import './ibzdepartment-pickup-view.less';
</style>