                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        ...
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.systeammember.gridviewtoolbar_toolbar.tbitem8.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </div>
...
export default class SysTeamMemberGridViewBase extends Vue {
	 ...
	 * @memberof SysTeamMemberGridViewBase
	 */
	public viewtag: string = '89ff98e46167a4688e63362931496818';
     ...
     */
    public model: any = {
        srfCaption: 'entities.systeammember.views.gridview.caption',
        srfTitle: 'entities.systeammember.views.gridview.title',
        srfSubTitle: 'entities.systeammember.views.gridview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-team-member-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.systeammember,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-team-member-grid-view',tag:this.viewtag,srfkey:this.context.systeammember,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-team-member-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysTeamMemberGridView')){
                    return;
                }
    ...
    public toolbar_tbitem24_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleRowEdit(datas, contextJO,paramJO,  $event, xData,this,"SysTeamMember");
    }
    ...
    public toolbar_tbitem25_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"SysTeamMember");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveRow(datas, contextJO,paramJO,  $event, xData,this,"SysTeamMember");
    }
    ...
    public toolbar_tbitem8_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"SysTeamMember");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"SysTeamMember");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        if(tempContext.sysemployee && true){
            deResParameters = [
        ...
        const view: any = {
            viewname: 'sys-team-member-edit-view', 
            height: 0, 
            width: 0,  
            title: this.$t('entities.systeammember.views.editview.title'),
...
<style lang='less'>
@import './sys-team-member-grid-view.less';
</style>