<template>
<div class="view-container deeditview ibzteam-member-edit-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzteammembereditview"></app-studioaction>
    ...
    <div class='toolbar-container'>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem3.visabled" :disabled="toolBarModels.tbitem3.disabled" class='' @click="toolbar_click({ tag: 'tbitem3' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.tbitem3.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.tbitem3.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.deuiaction2.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem14.visabled" :disabled="toolBarModels.tbitem14.disabled" class='' @click="toolbar_click({ tag: 'tbitem14' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.tbitem14.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.ibzteammember.editviewtoolbar_toolbar.tbitem14.tip')}}</div>
        </tooltip>
    </div>
</div>
...
import IBZTeamMemberAuthService from '@/authservice/ibzteam-member/ibzteam-member-auth-service';
...
export default class IBZTeamMemberEditViewBase extends Vue {

    /**
     * 实体服务对象
     *
     * @type {IBZTeamMemberService}
     * @memberof IBZTeamMemberEditViewBase
     */
    public appEntityService: IBZTeamMemberService = new IBZTeamMemberService;

    /**
     * 实体UI服务对象
     *
     * @type IBZTeamMemberUIService
     * @memberof IBZTeamMemberEditViewBase
     */
     ...
     */
    public model: any = {
        srfCaption: 'entities.ibzteammember.views.editview.caption',
        srfTitle: 'entities.ibzteammember.views.editview.title',
        srfSubTitle: 'entities.ibzteammember.views.editview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof IBZTeamMemberEditView
     */
    ...
    */
    ...
    public parseViewParam(inputvalue:any = null): void {
        ...
        if(inputvalue){
            Object.assign(this.context,{'ibzteammember':inputvalue});
        }
        //初始化视图唯一标识
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzteam-member-edit-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzteammember,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzteam-member-edit-view',tag:this.viewtag,srfkey:this.context.ibzteammember,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'ibzteam-member-edit-view')){
                return;
            }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
    ...
    public toolbar_tbitem9_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndStart(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
...
<style lang='less'>
@import './ibzteam-member-edit-view.less';
</style>