                    ...
                    <div class='toolbar-container'>
                        ...
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem8.visabled" :disabled="toolBarModels.tbitem8.disabled" class='' @click="toolbar_click({ tag: 'tbitem8' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.ibzteammember.gridviewtoolbar_toolbar.tbitem8.caption')}}</span>
                                </i-button>
...
export default class IBZTeamMemberGridViewBase extends Vue {
	 ...
	 * @memberof IBZTeamMemberGridViewBase
	 */
	public viewtag: string = '281f49b284494f9ba207e6bce8416b7d';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ibzteammember.views.gridview.caption',
        srfTitle: 'entities.ibzteammember.views.gridview.title',
        srfSubTitle: 'entities.ibzteammember.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'ibzteam-member-grid-view')){
                return;
            }
    ...
    public toolbar_tbitem24_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleRowEdit(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"IBZTeamMember");
    }
...
<style lang='less'>
@import './ibzteam-member-grid-view.less';
</style>