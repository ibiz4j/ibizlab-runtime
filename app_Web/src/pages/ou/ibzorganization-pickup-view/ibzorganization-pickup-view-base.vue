...
<div class="view-container depickupview ibzorganization-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzorganizationpickupview"></app-studioaction>
...
export default class IBZOrganizationPickupViewBase extends Vue {
	 ...
	 * @memberof IBZOrganizationPickupViewBase
	 */
	public viewtag: string = 'ccff36439eacae953f85ff636c9dac74';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzorganization-pickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzorganization,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzorganization-pickup-view',tag:this.viewtag,srfkey:this.context.ibzorganization,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
...
<style lang='less'>
@import './ibzorganization-pickup-view.less';
</style>