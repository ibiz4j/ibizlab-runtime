<template>
<div class="view-container deeditview ibzemployee-edit-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzemployeeeditview"></app-studioaction>
    ...
    <div class='toolbar-container'>
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.ibzemployee.editviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.ibzemployee.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.ibzemployee.editviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.ibzemployee.editviewtoolbar_toolbar.deuiaction2.tip')}}</div>
        </tooltip>
...
export default class IBZEmployeeEditViewBase extends Vue {
	 ...
	 * @memberof IBZEmployeeEditViewBase
	 */
	public viewtag: string = '119fe650e7efd26bd14bd413cae37ded';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ibzemployee.views.editview.caption',
        srfTitle: 'entities.ibzemployee.views.editview.title',
        srfSubTitle: 'entities.ibzemployee.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzemployee-edit-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzemployee,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzemployee-edit-view',tag:this.viewtag,srfkey:this.context.ibzemployee,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"IBZEmployee");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"IBZEmployee");
    }
    ...
    public toolbar_tbitem9_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndStart(datas, contextJO,paramJO,  $event, xData,this,"IBZEmployee");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"IBZEmployee");
    }
...
<style lang='less'>
@import './ibzemployee-edit-view.less';
</style>