<template>
<div class="view-container dempickupview sys-user-mpickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sysusermpickupview"></app-studioaction>
...
export default class SysUserMPickupViewBase extends Vue {
	 ...
	 * @memberof SysUserMPickupViewBase
	 */
	public viewtag: string = '1f8cf7e78d6d88588d1d568d1866cc77';
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysuser.views.mpickupview.caption',
        srfTitle: 'entities.sysuser.views.mpickupview.title',
        srfSubTitle: 'entities.sysuser.views.mpickupview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-user-mpickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysuser,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-user-mpickup-view',tag:this.viewtag,srfkey:this.context.sysuser,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-user-mpickup-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysUserMPickupView')){
                    return;
                }
...
<style lang='less'>
@import './sys-user-mpickup-view.less';
</style>