...
<div class='view-container degridview sys-user-role-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="sysuserrolegridview"></app-studioaction>
                    ...
                    <div class='toolbar-container'>
                        ...
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem18.visabled" :disabled="toolBarModels.tbitem18.disabled" class='' @click="toolbar_click({ tag: 'tbitem18' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.sysuserrole.gridviewtoolbar_toolbar.tbitem18.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.sysuserrole.gridviewtoolbar_toolbar.tbitem18.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </div>
...
export default class SysUserRoleGridViewBase extends Vue {
 ...
 tbitem23: { name: 'tbitem23', caption: '数据导入', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Import', target: '' } },
    ...
    public toolbar_tbitem18_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"SysUserRole");
    }
