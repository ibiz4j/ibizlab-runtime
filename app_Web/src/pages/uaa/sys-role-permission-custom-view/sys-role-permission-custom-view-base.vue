...
export default class SysRolePermissionCustomViewBase extends Vue {
    ...
    */
    ...
    public initNavData(data:any = null){
        if(this.viewDefaultUsage){
            this.navDataService.addNavData({id:'sys-role-permission-custom-view',srfkey:this.context.sysrolepermission,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-role-permission-custom-view')){
                return;
            }
...
<style lang='less'>
@import './sys-role-permission-custom-view.less';
</style>