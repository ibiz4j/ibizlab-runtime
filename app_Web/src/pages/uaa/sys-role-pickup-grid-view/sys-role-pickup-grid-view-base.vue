...
<div class='view-container depickupgridview sys-role-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="sysrolepickupgridview"></app-studioaction>
    ...
    */
    ...
    public initNavData(data:any = null){
        if(this.viewDefaultUsage){
            this.navDataService.addNavData({id:'sys-role-pickup-grid-view',srfkey:this.context.sysrole,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
