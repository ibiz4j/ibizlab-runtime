    ...
    */
    ...
    public initNavData(data:any = null){
        if(this.viewDefaultUsage){
            this.navDataService.addNavData({id:'sys-user-role-edit-view',srfkey:this.context.sysuserrole,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
