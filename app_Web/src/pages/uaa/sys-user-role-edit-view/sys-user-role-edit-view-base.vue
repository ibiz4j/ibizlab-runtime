        ...
        <div class='toolbar-container'>
            ...
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.tbitem7.visabled" :disabled="toolBarModels.tbitem7.disabled" class='' @click="toolbar_click({ tag: 'tbitem7' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.sysuserrole.editviewtoolbar_toolbar.tbitem7.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.sysuserrole.editviewtoolbar_toolbar.tbitem7.tip')}}</div>
            </tooltip>
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
            ...
            <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                    <i-button v-show="toolBarModels.tbitem22.visabled" :disabled="toolBarModels.tbitem22.disabled" class='' @click="toolbar_click({ tag: 'tbitem22' }, $event)">
                        ...
                        <span class='caption'>{{$t('entities.sysuserrole.editviewtoolbar_toolbar.tbitem22.caption')}}</span>
                    </i-button>
                <div slot='content'>{{$t('entities.sysuserrole.editviewtoolbar_toolbar.tbitem22.tip')}}</div>
            </tooltip>
        </div>
...
export default class SysUserRoleEditViewBase extends Vue {
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SysUserRole");
    }
