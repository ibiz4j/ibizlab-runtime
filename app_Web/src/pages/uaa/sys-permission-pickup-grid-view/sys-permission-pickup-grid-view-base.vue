...
<div class='view-container depickupgridview sys-permission-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="syspermissionpickupgridview"></app-studioaction>
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false){
        if(this.viewDefaultUsage && Object.is(this.navModel,"route")){
            this.navDataService.addNavData({id:'sys-permission-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.syspermission,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true){
        if(this.viewDefaultUsage && !Object.is(this.navModel,"route")){
            this.navDataService.addNavDataByOnly({id:'sys-permission-pickup-grid-view',tag:this.viewtag,srfkey:this.context.syspermission,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
