    ...
    <div class='toolbar-container'>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem3.visabled" :disabled="toolBarModels.tbitem3.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem3' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.jobsinfo.editviewtoolbar_toolbar.tbitem3.caption')}}</span>
                </i-button>
...
export default class JobsInfoEditViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.jobsinfo.views.editview.caption',
        srfTitle: 'entities.jobsinfo.views.editview.title',
        srfSubTitle: 'entities.jobsinfo.views.editview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        ...
        deuiaction2: { name: 'deuiaction2', actiontarget: 'NONE', caption: '保存并关闭', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'SaveAndExit', target: '' } },
   ...
   */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'jobs-info-edit-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'JobsInfoEditView')){
                    return;
                }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"JobsInfo");
    }
...
<style lang='less'>
@import './jobs-info-edit-view.less';
</style>