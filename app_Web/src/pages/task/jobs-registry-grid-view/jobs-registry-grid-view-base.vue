                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem26.visabled" :disabled="toolBarModels.tbitem26.disabled" class='' @click="toolbar_click({ tag: 'tbitem26' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem26.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem26.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem19.visabled" :disabled="toolBarModels.tbitem19.disabled" class='' @click="toolbar_click({ tag: 'tbitem19' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem19.caption')}}</span>
                                </i-button>
                        ...
                        <span class='seperator'>|</span>    <dropdown v-show="toolBarModels.tbitem17.visabled" trigger='click'>
                            <tooltip :transfer="true" :max-width="600">
                                    <i-button class=''>
                                        <i class=''></i>
                                        <span class='caption'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem17.caption')}}</span>
                                        <icon type="ios-arrow-down"></icon>
                                    </i-button>
                                <div slot='content'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem17.tip')}}</div>
                            </tooltip>
                            <dropdown-menu slot='list'>
                                <dropdown-item>
                                    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem29.visabled" :disabled="toolBarModels.tbitem29.disabled" class='' @click="toolbar_click({ tag: 'tbitem29' }, $event)">
                                    <i class='fa fa-download'></i>
                                    <span class='caption'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem29.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem29.tip')}}</div>
                        </tooltip>
                                ...
                                <dropdown-item>
                                    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem30.visabled" :disabled="toolBarModels.tbitem30.disabled" class='' @click="toolbar_click({ tag: 'tbitem30' }, $event)">
                                    <i class='fa fa-upload'></i>
                                    <span class='caption'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem30.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem30.tip')}}</div>
                        </tooltip>
                        ...
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.jobsregistry.gridviewtoolbar_toolbar.tbitem5.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </div>
...
export default class JobsRegistryGridViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.jobsregistry.views.gridview.caption',
        srfTitle: 'entities.jobsregistry.views.gridview.title',
        srfSubTitle: 'entities.jobsregistry.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        tbitem26: { name: 'tbitem26', caption: '新建', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'New', target: '' } },

        tbitem19: { name: 'tbitem19', caption: '编辑', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Edit', target: 'SINGLEKEY' } },
        ...
        tbitem9: { name: 'tbitem9', caption: '删除', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Remove', target: 'MULTIKEY' } },

        tbitem10: {  name: 'tbitem10', type: 'SEPERATOR', visabled: true, dataaccaction: '', uiaction: { } },
        tbitem11: { name: 'tbitem11', caption: '导出', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportExcel', target: '' }, MaxRowCount: 1000  },
 ...
 tbitem29: { name: 'tbitem29', caption: '导出数据模型', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ExportModel', target: '' } },

 tbitem30: { name: 'tbitem30', caption: '数据导入', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Import', target: '' } },


        tbitem2: {  name: 'tbitem2', type: 'SEPERATOR', visabled: true, dataaccaction: '', uiaction: { } },
        tbitem3: { name: 'tbitem3', caption: '过滤', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '' } },

        tbitem4: {  name: 'tbitem4', type: 'SEPERATOR', visabled: true, dataaccaction: '', uiaction: { } },
        tbitem5: { name: 'tbitem5', caption: '帮助', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'Help', target: '' } },
    ...
    */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'jobs-registry-grid-view')){
                return;
            }
    ...
    public toolbar_click($event: any, $event2?: any) {
        ...
        if (Object.is($event.tag, 'tbitem20')) {
            this.toolbar_tbitem20_click(null, '', $event2);
        }
        ...
        if (Object.is($event.tag, 'tbitem29')) {
            this.toolbar_tbitem29_click(null, '', $event2);
        }
        if (Object.is($event.tag, 'tbitem30')) {
            this.toolbar_tbitem30_click(null, '', $event2);
        }
    ...
    public toolbar_tbitem26_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem19_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem20_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        this.View(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem6_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Copy(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem24_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleRowEdit(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem25_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NewRow(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem9_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem11_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ExportExcel(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem13_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem29_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        this.ExportModel(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
     ...
     * @memberof 
     */
    public toolbar_tbitem30_click(params: any = {}, tag?: any, $event?: any) {
        // 参数
        // 取数
        let datas: any[] = [];
        let xData: any = null;
        ...
        // 界面行为
        this.Import(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Help(datas, contextJO,paramJO,  $event, xData,this,"JobsRegistry");
    }
    ...
    public newdata(args: any[],fullargs?:any[], params?: any, $event?: any, xData?: any) {
        ...
        delete tempContext.jobsregistry;
        if(args.length >0){
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { jobsregistry: args[0].jobsregistry })
            }
...
<style lang='less'>
@import './jobs-registry-grid-view.less';
</style>