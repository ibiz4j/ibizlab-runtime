<template>
<div class='view-container degridview meta-dynamicmodelgrid-view'>
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="meta_dynamicmodelgridview"></app-studioaction>
...
export default class META_DYNAMICMODELGridViewBase extends Vue {

    /**
     * 实体服务对象
     *
     * @type {MetaDynamicModelService}
     * @memberof META_DYNAMICMODELGridViewBase
     */
     ...
     *
     * @type {*}
     * @memberof META_DYNAMICMODELGridView
     */
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'meta-dynamicmodelgrid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.metadynamicmodel,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'meta-dynamicmodelgrid-view',tag:this.viewtag,srfkey:this.context.metadynamicmodel,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'meta-dynamicmodelgrid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'META_DYNAMICMODELGridView')){
                    return;
                }
...
<style lang='less'>
@import './meta-dynamicmodelgrid-view.less';
</style>