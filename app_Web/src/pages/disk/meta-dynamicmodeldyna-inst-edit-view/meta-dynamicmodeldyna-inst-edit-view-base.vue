<template>
<div class="view-container deeditview meta-dynamicmodeldyna-inst-edit-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="meta_dynamicmodeldynainsteditview"></app-studioaction>
    ...
    <div class='toolbar-container'>
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.metadynamicmodel.dynainsteditviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.metadynamicmodel.dynainsteditviewtoolbar_toolbar.deuiaction1.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.metadynamicmodel.dynainsteditviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.metadynamicmodel.dynainsteditviewtoolbar_toolbar.deuiaction2.tip')}}</div>
        </tooltip>
...
export default class META_DYNAMICMODELDynaInstEditViewBase extends Vue {

    /**
     * 实体服务对象
     *
     * @type {MetaDynamicModelService}
     * @memberof META_DYNAMICMODELDynaInstEditViewBase
     */
     ...
     *
     * @type {*}
     * @memberof META_DYNAMICMODELDynaInstEditView
     */
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'meta-dynamicmodeldyna-inst-edit-view',tag:this.viewtag,srfkey:isNew ? null : this.context.metadynamicmodel,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'meta-dynamicmodeldyna-inst-edit-view',tag:this.viewtag,srfkey:this.context.metadynamicmodel,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'meta-dynamicmodeldyna-inst-edit-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'META_DYNAMICMODELDynaInstEditView')){
                    return;
                }
...
<style lang='less'>
@import './meta-dynamicmodeldyna-inst-edit-view.less';
</style>