...
export default class MsgOpenAccessPickupGridViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.msgopenaccess.views.pickupgridview.caption',
        srfTitle: 'entities.msgopenaccess.views.pickupgridview.title',
        srfSubTitle: 'entities.msgopenaccess.views.pickupgridview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'msg-open-access-pickup-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'MsgOpenAccessPickupGridView')){
                    return;
                }
...
<style lang='less'>
@import './msg-open-access-pickup-grid-view.less';
</style>