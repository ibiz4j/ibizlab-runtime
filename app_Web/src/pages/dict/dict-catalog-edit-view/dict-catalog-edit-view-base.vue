    ...
    <div class='toolbar-container'>
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.deuiaction1.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.deuiaction2.visabled" :disabled="toolBarModels.deuiaction2.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'deuiaction2' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.deuiaction2.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.deuiaction2.tip')}}</div>
        </tooltip>
...
export default class DictCatalogEditViewBase extends Vue {
   ...
   */
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Exit(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
