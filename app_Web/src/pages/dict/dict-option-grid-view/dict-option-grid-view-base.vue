...
<div class='view-container degridview dict-option-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="dictoptiongridview"></app-studioaction>
...
export default class DictOptionGridViewBase extends Vue {
    ...
    public toolBarModels: any = {
        ...
        deuiaction2: { name: 'deuiaction2', caption: '过滤', disabled: false, type: 'DEUIACTION', visabled: true, dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '' } },
