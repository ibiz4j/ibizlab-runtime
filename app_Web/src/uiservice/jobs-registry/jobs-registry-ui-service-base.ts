...
export default class JobsRegistryUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'jobsregistries',component:'jobs-registry-grid-view'});
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'jobsregistries',component:'jobs-registry-edit-view'});
    }
