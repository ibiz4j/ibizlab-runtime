 ...
 *
 * @export
 * @class IBZDeptMemberUIServiceBase
 */
export default class IBZDeptMemberUIServiceBase extends UIService {
     ...
     * @memberof  IBZDeptMemberUIServiceBase
     */
    public dataService:IBZDeptMemberService = new IBZDeptMemberService();
    ...
    /**
     * Creates an instance of  IBZDeptMemberUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  IBZDeptMemberUIServiceBase
     */
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBZDeptMemberAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzdeptmember:srfkey});
