...
export default class IBZTeamUIServiceBase extends UIService {
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBZTeamAuthService(opts);
        this.initViewMap();
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'ibzteams'});
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'ibzteams'});
    }
