...
export default class SysUserUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('MPICKUPVIEW:',{viewname:'mpickupview',srfappde:'sysusers',component:'sys-user-mpickup-view'});
        this.allViewMap.set('PICKUPVIEW:',{viewname:'pickupview',srfappde:'sysusers',component:'sys-user-pickup-view'});
        this.allViewMap.set(':',{viewname:'pickupgridview',srfappde:'sysusers',component:'sys-user-pickup-grid-view'});
    }
