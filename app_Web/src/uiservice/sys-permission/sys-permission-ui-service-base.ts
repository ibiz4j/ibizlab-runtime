...
export default class SysPermissionUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('PICKUPVIEW:',{viewname:'pickupview',srfappde:'syspermissions',component:'sys-permission-pickup-view'});
        this.allViewMap.set('MPICKUPVIEW:',{viewname:'mpickupview',srfappde:'syspermissions',component:'sys-permission-mpickup-view'});
        this.allViewMap.set(':',{viewname:'pickupgridview',srfappde:'syspermissions',component:'sys-permission-pickup-grid-view'});
    }
