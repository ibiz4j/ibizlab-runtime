...
export default class SysRoleUIServiceBase extends UIService {
    ...
    public initViewMap(){
        ...
        this.allViewMap.set('PICKUPVIEW:',{viewname:'pickupview',srfappde:'sysroles',component:'sys-role-pickup-view'});
        ...
        this.allViewMap.set('MPICKUPVIEW:',{viewname:'mpickupview',srfappde:'sysroles',component:'sys-role-mpickup-view'});
    }
