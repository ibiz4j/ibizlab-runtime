...
export default class SysOpenAccessUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'sysopenaccesses',component:'sys-open-access-grid-view'});
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'sysopenaccesses',component:'sys-open-access-edit-view'});
    }
