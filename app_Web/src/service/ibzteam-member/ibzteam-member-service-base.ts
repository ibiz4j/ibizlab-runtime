...
// 实体接口
    ...
    public async Select(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.ibzorganization && context.ibzdepartment && context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().get(`/ibzorganizations/${context.ibzorganization}/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}/select`,isloading);

            return res;
        }
        if(context.ibzorganization && context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().get(`/ibzorganizations/${context.ibzorganization}/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}/select`,isloading);

            return res;
        }
        if(context.ibzdepartment && context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().get(`/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}/select`,isloading);

            return res;
        }
        if(context.ibzteam && context.ibzteammember){
            let res:any = Http.getInstance().get(`/ibzteams/${context.ibzteam}/ibzteammembers/${context.ibzteammember}/select`,isloading);

            return res;
        }
        if(context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().get(`/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}/select`,isloading);

            return res;
        }
            let res:any = Http.getInstance().get(`/ibzteammembers/${context.ibzteammember}/select`,isloading);
    ...
    public async Remove(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.ibzorganization && context.ibzdepartment && context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().delete(`/ibzorganizations/${context.ibzorganization}/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}`,isloading);
            return res;
        }
        if(context.ibzorganization && context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().delete(`/ibzorganizations/${context.ibzorganization}/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}`,isloading);
            return res;
        }
        if(context.ibzdepartment && context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().delete(`/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}`,isloading);
            return res;
        }
        if(context.ibzteam && context.ibzteammember){
            let res:any = Http.getInstance().delete(`/ibzteams/${context.ibzteam}/ibzteammembers/${context.ibzteammember}`,isloading);
            return res;
        }
        if(context.ibzemployee && context.ibzteammember){
            let res:any = Http.getInstance().delete(`/ibzemployees/${context.ibzemployee}/ibzteammembers/${context.ibzteammember}`,isloading);
            return res;
        }
            let res:any = Http.getInstance().delete(`/ibzteammembers/${context.ibzteammember}`,isloading);
            return res;
    }
    ...
    public async CheckKey(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if(context.ibzemployee && context.ibzteammember){
            ...
            let res:any = Http.getInstance().post(`/ibzteammembers/${context.ibzteammember}/checkkey`,data,isloading);
            return res;
    }
    ...
    public async FetchDefault(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.ibzorganization && context.ibzdepartment && context.ibzemployee && true){
            ...
            let res:any = Http.getInstance().get(`/ibzorganizations/${context.ibzorganization}/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/fetchdefault`,tempData,isloading);
            return res;
        }
        if(context.ibzorganization && context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            let res:any = Http.getInstance().get(`/ibzorganizations/${context.ibzorganization}/ibzemployees/${context.ibzemployee}/ibzteammembers/fetchdefault`,tempData,isloading);
            return res;
        }
        if(context.ibzdepartment && context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            let res:any = Http.getInstance().get(`/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/fetchdefault`,tempData,isloading);
            return res;
        }
        if(context.ibzteam && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            let res:any = Http.getInstance().get(`/ibzteams/${context.ibzteam}/ibzteammembers/fetchdefault`,tempData,isloading);
            return res;
        }
        if(context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            let res:any = Http.getInstance().get(`/ibzemployees/${context.ibzemployee}/ibzteammembers/fetchdefault`,tempData,isloading);
            return res;
        }
        let tempData:any = JSON.parse(JSON.stringify(data));
        let res:any = Http.getInstance().get(`/ibzteammembers/fetchdefault`,tempData,isloading);
        return res;
    }
    ...
    public async searchDefault(context: any = {},data: any = {}, isloading?: boolean): Promise<any> {
        if(context.ibzorganization && context.ibzdepartment && context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            return Http.getInstance().post(`/ibzorganizations/${context.ibzorganization}/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/searchdefault`,tempData,isloading);
        }
        if(context.ibzorganization && context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            return Http.getInstance().post(`/ibzorganizations/${context.ibzorganization}/ibzemployees/${context.ibzemployee}/ibzteammembers/searchdefault`,tempData,isloading);
        }
        if(context.ibzdepartment && context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            return Http.getInstance().post(`/ibzdepartments/${context.ibzdepartment}/ibzemployees/${context.ibzemployee}/ibzteammembers/searchdefault`,tempData,isloading);
        }
        if(context.ibzteam && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            return Http.getInstance().post(`/ibzteams/${context.ibzteam}/ibzteammembers/searchdefault`,tempData,isloading);
        }
        if(context.ibzemployee && true){
            let tempData:any = JSON.parse(JSON.stringify(data));
            return Http.getInstance().post(`/ibzemployees/${context.ibzemployee}/ibzteammembers/searchdefault`,tempData,isloading);
        }
        let tempData:any = JSON.parse(JSON.stringify(data));
        return Http.getInstance().post(`/ibzteammembers/searchdefault`,tempData,isloading);
    }
}