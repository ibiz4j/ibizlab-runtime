...
function getLocaleResourceBase(){
	...
	fields: {
		...
		views: {
			mpickupview: {
				caption: commonLogic.appcommonhandle("Internal Error",null),
				title: commonLogic.appcommonhandle("Condition",null),
			},
			pickupview: {
				caption: commonLogic.appcommonhandle("Internal Error",null),
			...
			pickupgridview: {
				caption: commonLogic.appcommonhandle("Internal Error",null),
				title: commonLogic.appcommonhandle("Please save [{0}] before you manage [{1}]",null),
			},
		},
		main_grid: {
			columns: {
		...
		default_searchform: {
			details: {
				formpage1: commonLogic.appcommonhandle("Pickup View",null), 
