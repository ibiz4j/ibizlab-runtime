...
export default class OrgTreeService extends ControlService {
     ...
     */
    public appEntityService: IBZOrganizationService = new IBZOrganizationService({ $store: this.getStore() });
            ...
            try {
                this.searchOrg(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        ...
                        Object.assign(treeNode,{srfparentdename:'IBZOrganization',srfparentkey:entity.orgid});
                        let tempContext:any = JSON.parse(JSON.stringify(context));
                        Object.assign(tempContext,{srfparentdename:'IBZOrganization',srfparentkey:entity.orgid,ibzorganization:strId})
                        Object.assign(treeNode,{srfappctx:tempContext});
                        Object.assign(treeNode,{'ibzorganization':strId});
