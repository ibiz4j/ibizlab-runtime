...
import DeptTreeModel from './dept-tree-treeview-model';
 ...
 */
export default class DeptTreeService extends ControlService {

    /**
     * 部门服务对象
     *
     * @type {IBZDepartmentService}
     * @memberof DeptTreeService
     */
    ...
    /**
     * Creates an instance of DeptTreeService.
     * 
     * @param {*} [opts={}]
     * @memberof DeptTreeService
     */
     ...
     * @memberof DeptTreeService
     */
	public TREENODE_DEPT: string = 'Dept';
    ...
    public async getNodes(context:any = {},data: any = {}, isloading?: boolean): Promise<any> {
        ...
        if (Object.is(strNodeType, this.TREENODE_DEPT)) {
            await this.fillDeptNodeChilds(context,filter, list);
     ...
     */
    @Errorlog
    public fillDeptNodes(context:any={},filter: any, list: any[],rsNavContext?:any,rsNavParams?:any,rsParams?:any): Promise<any> {
        ...
        return new Promise((resolve:any,reject:any) =>{
            ...
            let records: any[] = [];
            try {
                this.searchDept(context, searchFilter, filter).then((records:any) =>{
                    if(records && records.length >0){
                        ...
                        Object.assign(treeNode,{srfparentdename:'IBZDepartment',srfparentkey:entity.deptid});
                        let tempContext:any = JSON.parse(JSON.stringify(context));
                        Object.assign(tempContext,{srfparentdename:'IBZDepartment',srfparentkey:entity.deptid,ibzdepartment:strId})
                        Object.assign(treeNode,{srfappctx:tempContext});
                        Object.assign(treeNode,{'ibzdepartment':strId});
                        Object.assign(treeNode, { srfkey: strId });
                        Object.assign(treeNode, { text: strText, srfmajortext: strText });
                        let strNodeId: string = 'Dept';
     ...
     */
    @Errorlog
    public searchDept(context:any={}, searchFilter: any, filter: any): Promise<any> {
        return new Promise((resolve:any,reject:any) =>{
     ...
     */
    @Errorlog
    public async fillDeptNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
    ...
    public async fillRootNodeChilds(context:any={}, filter: any, list: any[]): Promise<any> {
		if (filter.srfnodefilter && !Object.is(filter.srfnodefilter,"")) {
			// 填充部门
            let DeptRsNavContext:any = {};
            let DeptRsNavParams:any = {};
            let DeptRsParams:any = {};
			await this.fillDeptNodes(context, filter, list ,DeptRsNavContext,DeptRsNavParams,DeptRsParams);
		} else {
			// 填充部门
            let DeptRsNavContext:any = {};
            let DeptRsNavParams:any = {};
