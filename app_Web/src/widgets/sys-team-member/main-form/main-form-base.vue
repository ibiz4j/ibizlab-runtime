<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='systeammember_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group :uiService="appUIService" :data="transformData(data)" :manageContainerStatus="detailsModel.group1.manageContainerStatus"  :isManageContainer="detailsModel.group1.isManageContainer" @managecontainerclick="manageContainerClick('group1')" layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.systeammember.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
        <i-col v-show="detailsModel.personname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='personname' :itemRules="this.rules().personname" class='' :caption="$t('entities.systeammember.main_form.details.personname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.personname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.postname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='postname' :itemRules="this.rules().postname" class='' :caption="$t('entities.systeammember.main_form.details.postname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.postname.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        srfkey: [
            ...
            { required: this.detailsModel.srfkey.required, type: 'string', message: '组成员标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.srfkey.required, type: 'string', message: '组成员标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
        ...
        postname: [
            ...
            { required: this.detailsModel.postname.required, type: 'string', message: '岗位 值不能为空', trigger: 'change' },
            { required: this.detailsModel.postname.required, type: 'string', message: '岗位 值不能为空', trigger: 'blur' },
        ],
        domains: [
            { type: 'string', message: '区属 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '区属 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.domains.required, type: 'string', message: '区属 值不能为空', trigger: 'change' },
            { required: this.detailsModel.domains.required, type: 'string', message: '区属 值不能为空', trigger: 'blur' },
        ],
        teamid: [
            { type: 'string', message: '组标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '组标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.teamid.required, type: 'string', message: '组标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.teamid.required, type: 'string', message: '组标识 值不能为空', trigger: 'blur' },
        ],
        postid: [
            { type: 'string', message: '岗位标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '岗位标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.postid.required, type: 'string', message: '岗位标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.postid.required, type: 'string', message: '岗位标识 值不能为空', trigger: 'blur' },
        ],
        userid: [
        ...
        teammemberid: [
            { type: 'string', message: '组成员标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '组成员标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.teammemberid.required, type: 'string', message: '组成员标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.teammemberid.required, type: 'string', message: '组成员标识 值不能为空', trigger: 'blur' },
        ],
        }
    }
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '组成员基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, isControlledContent: false , uiActionGroup: { caption: '', langbase: 'entities.systeammember.main_form', extractMode: 'ITEM', details: [] }, isManageContainer: false, showMoreModeItems: []  })
, 
...
, 
        srfkey: new FormItemModel({ caption: '组成员标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        postname: new FormItemModel({ caption: '岗位', detailType: 'FORMITEM', name: 'postname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        domains: new FormItemModel({ caption: '区属', detailType: 'FORMITEM', name: 'domains', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        teamid: new FormItemModel({ caption: '组标识', detailType: 'FORMITEM', name: 'teamid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        teammemberid: new FormItemModel({ caption: '组成员标识', detailType: 'FORMITEM', name: 'teammemberid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
    };
    ...
    /**
     * 监控表单属性 teammemberid 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof MainBase
     */
    @Watch('data.teammemberid')
    onTeammemberidChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'teammemberid', newVal: newVal, oldVal: oldVal });
    }
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.systeammember){
            Object.assign(this.context,{systeammember:data.systeammember})
        }
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'systeammember_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamMemberEditView' + (this.$t('app.formpage.notconfig.loadaction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamMemberEditView' + (this.$t('app.formpage.notconfig.loaddraftaction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamMemberEditView' + (this.$t('app.formpage.notconfig.actionname') as string) });
            return;
        }
        ...
        post.then((response: any) => {
            ...
            this.$emit('save', data);
            AppCenterService.notifyMessage({name:"SysTeamMember",action:'appRefresh',data:data});
            this.$nextTick(() => {
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamMemberEditView' + (this.$t('app.formpage.notconfig.removeaction') as string) });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.systeammember || Object.is(arg.systeammember, '')) {
            return;
        }
