<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysorganization_main' style="" @on-validate="formItemValidate">
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.sysorganization});
        }
        if (this.viewState) {
