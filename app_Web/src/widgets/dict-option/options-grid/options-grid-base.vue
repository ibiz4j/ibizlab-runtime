    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('cid')">
                <el-table-column show-overflow-tooltip :prop="'cid'" :label="$t('entities.dictoption.options_grid.columns.cid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.cid')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('val')">
                <el-table-column show-overflow-tooltip :prop="'val'" :label="$t('entities.dictoption.options_grid.columns.val')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.val')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('label')">
                <el-table-column show-overflow-tooltip :prop="'label'" :label="$t('entities.dictoption.options_grid.columns.label')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.label')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('pval')">
                <el-table-column show-overflow-tooltip :prop="'pval'" :label="$t('entities.dictoption.options_grid.columns.pval')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.pval')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('showorder')">
                <el-table-column show-overflow-tooltip :prop="'showorder'" :label="$t('entities.dictoption.options_grid.columns.showorder')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.showorder')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('cname')">
                <el-table-column show-overflow-tooltip :prop="'cname'" :label="$t('entities.dictoption.options_grid.columns.cname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.cname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('cls')">
                <el-table-column show-overflow-tooltip :prop="'cls'" :label="$t('entities.dictoption.options_grid.columns.cls')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.cls')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('iconcls')">
                <el-table-column show-overflow-tooltip :prop="'iconcls'" :label="$t('entities.dictoption.options_grid.columns.iconcls')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.iconcls')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('vfilter')">
                <el-table-column show-overflow-tooltip :prop="'vfilter'" :label="$t('entities.dictoption.options_grid.columns.vfilter')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.vfilter')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('disabled')">
                <el-table-column show-overflow-tooltip :prop="'disabled'" :label="$t('entities.dictoption.options_grid.columns.disabled')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('expired')">
                <el-table-column show-overflow-tooltip :prop="'expired'" :label="$t('entities.dictoption.options_grid.columns.expired')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('extension')">
                <el-table-column show-overflow-tooltip :prop="'extension'" :label="$t('entities.dictoption.options_grid.columns.extension')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.dictoption.options_grid.columns.extension')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
...
import DictOptionEntityService from '@/service/dict-option/dict-option-service';
...
export default class OptionsBase extends Vue implements ControlInterface {
     ...
     * @memberof OptionsBase
     */
    public appEntityService: DictOptionEntityService = new DictOptionEntityService({ $store: this.$store });
    ...
    */
    ...
    public rules(){
        return {
            val: [
                { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.val')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.val')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            pval: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.pval')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.pval')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            cls: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.cls')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.cls')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            expired: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.expired')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.expired')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            label: [
                { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.label')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.label')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            cid: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.cid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.cid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            srfkey: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            iconcls: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.iconcls')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.iconcls')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            extension: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.extension')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.extension')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            vfilter: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.vfilter')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.vfilter')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            showorder: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.showorder')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.showorder')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            cname: [
                { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.cname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.cname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            disabled: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.disabled')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.dictoption.options_grid.columns.disabled')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
        }
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'DictOptionGridEditView'+(this.$t('app.gridpage.notConfig.fetchAction') as string) });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'DictOptionGridEditView'+(this.$t('app.gridpage.notConfig.removeAction') as string) });
            return;
        }
        let _datas:any[] = [];
        ...
        const doExport = async (_data:any) => {
            ...
            this.$export.exportExcel().then((excel:any)=>{
                excel.export_json_to_excel({
                  ...
                  data, //具体数据 必填
                  filename: "字典项"+(this.$t('app.gridpage.grid') as string), //非必填
                  autoWidth: true, //非必填
                  bookType: "xlsx" //非必填
                });
            }); 
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['cid','val','label','pval','showorder','cname','cls','iconcls','vfilter','disabled','expired','extension'];
        if(row && row.children) {
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.dictoption,$event.dictoption);
        });
    ...
    public setColState() {
        ...
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzrt_web_dictoptiongrideditview_grid_options'});
    ...
    public getColStorage() {
        const _data: any = localStorage.getItem('dict_option_options_grid');
        if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('dict_option_options_grid', JSON.stringify(this.allColumns));
    }
    ...
    public saveDynaConfig() {
        const viewParams: any = Util.deepCopy(this.viewparams);
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzrt_web_dictoptiongrideditview_grid_options', model: this.allColumns});
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'DictOptionGridEditView'+(this.$t('app.gridpage.notConfig.createAction') as string) });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'DictOptionGridEditView'+(this.$t('app.gridpage.notConfig.updateAction') as string) });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.dictoption){
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'DictOptionGridEditView'+(this.$t('app.gridpage.notConfig.loaddraftAction') as string) });
            return;
        }
        let _this = this;
