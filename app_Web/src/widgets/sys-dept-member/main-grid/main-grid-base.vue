    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('deptname')">
                <el-table-column show-overflow-tooltip :prop="'deptname'" :label="$t('entities.sysdeptmember.main_grid.columns.deptname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdeptmember.main_grid.columns.deptname')}}
                      </span>
                    </template>
            ...
            <app-picker 
              ...
              :service="service"
              :acParams="{ serviceName: 'SysDepartmentService', interfaceName: 'FetchDefault'}"
              valueitem='deptid' 
              :value="row[column.property]" 
              editortype="" 
              :pickupView="{ viewname: 'sys-department-pickup-view', title: $t('entities.sysdepartment.views.pickupview.title'), deResParameters: [{ pathName: 'sysorganizations', parameterName: 'sysorganization' }, ], parameters: [{ pathName: 'sysdepartments', parameterName: 'sysdepartment' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
              style=""  
            ...
            <template v-if="getColumnState('postname')">
                <el-table-column show-overflow-tooltip :prop="'postname'" :label="$t('entities.sysdeptmember.main_grid.columns.postname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdeptmember.main_grid.columns.postname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('personname')">
                <el-table-column show-overflow-tooltip :prop="'personname'" :label="$t('entities.sysdeptmember.main_grid.columns.personname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdeptmember.main_grid.columns.personname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <app-picker 
              ...
              :service="service"
              :acParams="{ serviceName: 'SysEmployeeService', interfaceName: 'FetchDefault'}"
              valueitem='userid' 
              :value="row[column.property]" 
              editortype="" 
              :pickupView="{ viewname: 'sys-employee-pickup-view', title: $t('entities.sysemployee.views.pickupview.title'), deResParameters: [{ pathName: 'sysdepartments', parameterName: 'sysdepartment' }, ], parameters: [{ pathName: 'sysemployees', parameterName: 'sysemployee' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
              style=""  
              @formitemvaluechange="($event)=>{onGridItemValueChange(row,$event,$index)}">
            </app-picker>
            ...
            <template v-if="getColumnState('deptid')">
                <el-table-column show-overflow-tooltip :prop="'deptid'" :label="$t('entities.sysdeptmember.main_grid.columns.deptid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdeptmember.main_grid.columns.deptid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('postid')">
                <el-table-column show-overflow-tooltip :prop="'postid'" :label="$t('entities.sysdeptmember.main_grid.columns.postid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdeptmember.main_grid.columns.postid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
            ...
            <template v-if="getColumnState('userid')">
                <el-table-column show-overflow-tooltip :prop="'userid'" :label="$t('entities.sysdeptmember.main_grid.columns.userid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdeptmember.main_grid.columns.userid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template v-if="actualIsOpenEdit && !row.children">
...
import SysDeptMemberEntityService from '@/service/sys-dept-member/sys-dept-member-service';
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: SysDeptMemberEntityService = new SysDeptMemberEntityService({ $store: this.$store });
    ...
    */
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'deptname';
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'deptname',
            label: '部门',
            langtag: 'entities.sysdeptmember.main_grid.columns.deptname',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'postname',
            label: '岗位名称',
            langtag: 'entities.sysdeptmember.main_grid.columns.postname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: true,
            enableCond: 3 ,
        },
        {
            name: 'personname',
            label: '成员',
            langtag: 'entities.sysdeptmember.main_grid.columns.personname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: true,
            enableCond: 3 ,
        },
        {
            name: 'deptid',
            label: '部门标识',
            langtag: 'entities.sysdeptmember.main_grid.columns.deptid',
            show: false,
            unit: 'PX',
            isEnableRowEdit: true,
            enableCond: 3 ,
        },
        {
            name: 'postid',
            label: '岗位标识',
            langtag: 'entities.sysdeptmember.main_grid.columns.postid',
            show: false,
            unit: 'PX',
            isEnableRowEdit: true,
            enableCond: 3 ,
        },
        {
            name: 'userid',
            label: '用户标识',
            langtag: 'entities.sysdeptmember.main_grid.columns.userid',
            show: false,
            unit: 'PX',
            isEnableRowEdit: true,
            enableCond: 3 ,
    ...
    public rules(){
        return {
            postid: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.postid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.postid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            deptid: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.deptid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.deptid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            postname: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.postname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.postname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            userid: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.userid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.userid')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            personname: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.personname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.personname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            deptname: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.deptname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.deptname')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
            srfkey: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdeptmember.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
        }
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDeptMemberGridView'+(this.$t('app.gridpage.notConfig.fetchAction') as string) });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDeptMemberGridView'+(this.$t('app.gridpage.notConfig.removeAction') as string) });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.personname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ sysdeptmember: _keys }),Object.assign({ sysdeptmember: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
        ...
        const doExport = async (_data:any) => {
            ...
            this.$export.exportExcel().then((excel:any)=>{
                excel.export_json_to_excel({
                  ...
                  data, //具体数据 必填
                  filename: "部门成员"+(this.$t('app.gridpage.grid') as string), //非必填
                  autoWidth: true, //非必填
                  bookType: "xlsx" //非必填
                });
            }); 
    ...
    public afterCreated(){
        ...
        if(AppCenterService && AppCenterService.getMessageCenter()){
            this.appStateEvent = AppCenterService.getMessageCenter().subscribe(({ name, action, data }) =>{
                if(!Object.is(name,"SysDeptMember")){
                    return;
                }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['deptname','postname','personname','deptid','postid','userid'];
        if(row && row.children) {
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.sysdeptmember,$event.sysdeptmember);
        });
    ...
    public setColState() {
        ...
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzrt_web_sysdeptmembergridview_grid_main'});
    ...
    public getColStorage() {
        const _data: any = localStorage.getItem('sys_deptmember_main_grid');
        if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('sys_deptmember_main_grid', JSON.stringify(this.allColumns));
    }
    ...
    public saveDynaConfig() {
        const viewParams: any = Util.deepCopy(this.viewparams);
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzrt_web_sysdeptmembergridview_grid_main', model: this.allColumns});
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDeptMemberGridView'+(this.$t('app.gridpage.notConfig.createAction') as string) });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDeptMemberGridView'+(this.$t('app.gridpage.notConfig.updateAction') as string) });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.sysdeptmember){
                            Object.assign(this.context,{sysdeptmember:item.sysdeptmember});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDeptMemberGridView'+(this.$t('app.gridpage.notConfig.loaddraftAction') as string) });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.sysdeptmember,args.row.sysdeptmember);
        });
