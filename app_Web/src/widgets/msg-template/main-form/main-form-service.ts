...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: MsgTemplateService = new MsgTemplateService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public msgopenaccessService: MsgOpenAccessService = new MsgOpenAccessService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'MsgOpenAccessService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.msgopenaccessService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'id', 'msgopenaccess');
        }
