<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='msgtemplate_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "template_name";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.msgtemplate});
        }
        if (this.viewState) {
