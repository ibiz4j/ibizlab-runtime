...
, 
     ...
     * @memberof DefaultBase
     */
    @Watch('data.n_job_id_eq')
    onN_job_id_eqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_job_id_eq', newVal: newVal, oldVal: oldVal });
    }
    ...
    /**
     * 监控表单属性 n_trigger_code_eq 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof DefaultBase
     */
    @Watch('data.n_trigger_code_eq')
    onN_trigger_code_eqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_trigger_code_eq', newVal: newVal, oldVal: oldVal });
    }
