<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysdepartment_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.deptcode.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='deptcode' :itemRules="this.rules().deptcode" class='' :caption="$t('entities.sysdepartment.main_form.details.deptcode')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.deptcode.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
    v-model="data.deptcode"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.deptcode.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.deptname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='deptname' :itemRules="this.rules().deptname" class='' :caption="$t('entities.sysdepartment.main_form.details.deptname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.deptname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.orgname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='orgname' :itemRules="this.rules().orgname" class='' :caption="$t('entities.sysdepartment.main_form.details.orgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.orgname.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.shortname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='shortname' :itemRules="this.rules().shortname" class='' :caption="$t('entities.sysdepartment.main_form.details.shortname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.shortname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.bcode.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='bcode' :itemRules="this.rules().bcode" class='' :caption="$t('entities.sysdepartment.main_form.details.bcode')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.bcode.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
    v-model="data.bcode"  
    @enter="onEnter($event)"  
     unit=""  
...
<i-col v-show="detailsModel.deptlevel.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='deptlevel' :itemRules="this.rules().deptlevel" class='' :caption="$t('entities.sysdepartment.main_form.details.deptlevel')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.deptlevel.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
    v-model="data.deptlevel"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.deptlevel.disabled" 
    type='number' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.leadername.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='leadername' :itemRules="this.rules().leadername" class='' :caption="$t('entities.sysdepartment.main_form.details.leadername')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.leadername.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.showorder.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='showorder' :itemRules="this.rules().showorder" class='' :caption="$t('entities.sysdepartment.main_form.details.showorder')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.showorder.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        srfkey: [
            ...
            { required: this.detailsModel.srfkey.required, type: 'string', message: '部门标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.srfkey.required, type: 'string', message: '部门标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '部门名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '部门名称 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.srfmajortext.required, type: 'string', message: '部门名称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.srfmajortext.required, type: 'string', message: '部门名称 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        deptid: [
            { type: 'string', message: '部门标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '部门标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.deptid.required, type: 'string', message: '部门标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.deptid.required, type: 'string', message: '部门标识 值不能为空', trigger: 'blur' },
        ],
        deptcode: [
            { type: 'string', message: '部门代码 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '部门代码 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.deptcode.required, type: 'string', message: '部门代码 值不能为空', trigger: 'change' },
            { required: this.detailsModel.deptcode.required, type: 'string', message: '部门代码 值不能为空', trigger: 'blur' },
        ],
        deptname: [
            { type: 'string', message: '部门名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '部门名称 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.deptname.required, type: 'string', message: '部门名称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.deptname.required, type: 'string', message: '部门名称 值不能为空', trigger: 'blur' },
        ],
        orgname: [
        ...
        pdeptname: [
            ...
            { required: this.detailsModel.pdeptname.required, type: 'string', message: '上级部门 值不能为空', trigger: 'change' },
            { required: this.detailsModel.pdeptname.required, type: 'string', message: '上级部门 值不能为空', trigger: 'blur' },
        ],
        orgid: [
            { type: 'string', message: '单位 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '单位 值必须为字符串类型', trigger: 'blur' },
        ...
        pdeptid: [
            { type: 'string', message: '上级部门 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '上级部门 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.pdeptid.required, type: 'string', message: '上级部门 值不能为空', trigger: 'change' },
            { required: this.detailsModel.pdeptid.required, type: 'string', message: '上级部门 值不能为空', trigger: 'blur' },
        ],
        shortname: [
            { type: 'string', message: '部门简称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '部门简称 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.shortname.required, type: 'string', message: '部门简称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.shortname.required, type: 'string', message: '部门简称 值不能为空', trigger: 'blur' },
        ],
        bcode: [
        ...
        deptlevel: [
            { type: 'number', message: '部门级别 值必须为数值类型', trigger: 'change' },
            { type: 'number', message: '部门级别 值必须为数值类型', trigger: 'blur' },
            { required: this.detailsModel.deptlevel.required, type: 'number', message: '部门级别 值不能为空', trigger: 'change' },
            { required: this.detailsModel.deptlevel.required, type: 'number', message: '部门级别 值不能为空', trigger: 'blur' },
        ],
        leaderid: [
            { type: 'string', message: '分管领导标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '分管领导标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.leaderid.required, type: 'string', message: '分管领导标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.leaderid.required, type: 'string', message: '分管领导标识 值不能为空', trigger: 'blur' },
        ],
        leadername: [
            { type: 'string', message: '分管领导 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '分管领导 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.leadername.required, type: 'string', message: '分管领导 值不能为空', trigger: 'change' },
            { required: this.detailsModel.leadername.required, type: 'string', message: '分管领导 值不能为空', trigger: 'blur' },
        ],
        showorder: [
...
, 
        srfkey: new FormItemModel({ caption: '部门标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '部门名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        deptid: new FormItemModel({ caption: '部门标识', detailType: 'FORMITEM', name: 'deptid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        deptcode: new FormItemModel({ caption: '部门代码', detailType: 'FORMITEM', name: 'deptcode', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:true, disabled: false, enableCond: 1 })
, 
        deptname: new FormItemModel({ caption: '部门名称', detailType: 'FORMITEM', name: 'deptname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:true, disabled: false, enableCond: 3 })
, 
...
, 
        pdeptname: new FormItemModel({ caption: '上级部门', detailType: 'FORMITEM', name: 'pdeptname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        pdeptid: new FormItemModel({ caption: '上级部门', detailType: 'FORMITEM', name: 'pdeptid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        shortname: new FormItemModel({ caption: '部门简称', detailType: 'FORMITEM', name: 'shortname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        deptlevel: new FormItemModel({ caption: '部门级别', detailType: 'FORMITEM', name: 'deptlevel', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        leaderid: new FormItemModel({ caption: '分管领导标识', detailType: 'FORMITEM', name: 'leaderid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
     ...
     * @memberof MainBase
     */
    @Watch('data.deptlevel')
    onDeptlevelChange(newVal: any, oldVal: any) {
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.sysdepartment){
            Object.assign(this.context,{sysdepartment:data.sysdepartment})
        }
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'sysdepartment_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentEditView' + (this.$t('app.formpage.notconfig.loadaction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentEditView' + (this.$t('app.formpage.notconfig.loaddraftaction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentEditView' + (this.$t('app.formpage.notconfig.actionname') as string) });
            return;
        }
        ...
        post.then((response: any) => {
            ...
            this.$emit('save', data);
            AppCenterService.notifyMessage({name:"SysDepartment",action:'appRefresh',data:data});
            this.$nextTick(() => {
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentEditView' + (this.$t('app.formpage.notconfig.removeaction') as string) });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.sysdepartment || Object.is(arg.sysdepartment, '')) {
            return;
        }
