  ...
  <i-form style="height:100%;display:flex;flex-direction: column;justify-content: space-between">
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            <template slot="empty">
                {{$t('entities.sysdepartment.main_grid.nodata')}} 
            </template>
            <template v-if="!isSingleSelect">
                <el-table-column align="center" type='selection' :width="checkboxColWidth"></el-table-column>
            </template>
            <template v-if="getColumnState('deptcode')">
                <el-table-column show-overflow-tooltip :prop="'deptcode'" :label="$t('entities.sysdepartment.main_grid.columns.deptcode')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.deptcode')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('deptname')">
                <el-table-column show-overflow-tooltip :prop="'deptname'" :label="$t('entities.sysdepartment.main_grid.columns.deptname')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.deptname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgname')">
                <el-table-column show-overflow-tooltip :prop="'orgname'" :label="$t('entities.sysdepartment.main_grid.columns.orgname')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.orgname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('pdeptname')">
                <el-table-column show-overflow-tooltip :prop="'pdeptname'" :label="$t('entities.sysdepartment.main_grid.columns.pdeptname')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.pdeptname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('deptlevel')">
                <el-table-column show-overflow-tooltip :prop="'deptlevel'" :label="$t('entities.sysdepartment.main_grid.columns.deptlevel')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.deptlevel')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.sysdepartment.main_grid.columns.shortname')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.shortname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('bcode')">
                <el-table-column show-overflow-tooltip :prop="'bcode'" :label="$t('entities.sysdepartment.main_grid.columns.bcode')" :width="150"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.bcode')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.bcode}}</span>
            ...
            <template v-if="getColumnState('leadername')">
                <el-table-column show-overflow-tooltip :prop="'leadername'" :label="$t('entities.sysdepartment.main_grid.columns.leadername')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.leadername')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('createdate')">
                <el-table-column show-overflow-tooltip :prop="'createdate'" :label="$t('entities.sysdepartment.main_grid.columns.createdate')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.createdate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('updatedate')">
                <el-table-column show-overflow-tooltip :prop="'updatedate'" :label="$t('entities.sysdepartment.main_grid.columns.updatedate')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.updatedate')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('orgid')">
                <el-table-column show-overflow-tooltip :prop="'orgid'" :label="$t('entities.sysdepartment.main_grid.columns.orgid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.orgid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.orgid}}</span>
            ...
            <template v-if="getColumnState('pdeptid')">
                <el-table-column show-overflow-tooltip :prop="'pdeptid'" :label="$t('entities.sysdepartment.main_grid.columns.pdeptid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.pdeptid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('leaderid')">
                <el-table-column show-overflow-tooltip :prop="'leaderid'" :label="$t('entities.sysdepartment.main_grid.columns.leaderid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysdepartment.main_grid.columns.leaderid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'deptcode',
            label: '部门代码',
            langtag: 'entities.sysdepartment.main_grid.columns.deptcode',
            show: true,
            unit: 'px',
        ...
        },
        {
            name: 'deptname',
            label: '部门名称',
            langtag: 'entities.sysdepartment.main_grid.columns.deptname',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'orgname',
            label: '单位',
            langtag: 'entities.sysdepartment.main_grid.columns.orgname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'pdeptname',
            label: '上级部门',
            langtag: 'entities.sysdepartment.main_grid.columns.pdeptname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'deptlevel',
            label: '部门级别',
            langtag: 'entities.sysdepartment.main_grid.columns.deptlevel',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'shortname',
            label: '部门简称',
            langtag: 'entities.sysdepartment.main_grid.columns.shortname',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'bcode',
            label: '业务编码',
            langtag: 'entities.sysdepartment.main_grid.columns.bcode',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'leadername',
            label: '分管领导',
            langtag: 'entities.sysdepartment.main_grid.columns.leadername',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        ...
        },
        {
            name: 'showorder',
            label: '排序',
            langtag: 'entities.sysdepartment.main_grid.columns.showorder',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'createdate',
            label: '创建时间',
            langtag: 'entities.sysdepartment.main_grid.columns.createdate',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'updatedate',
            label: '最后修改时间',
            langtag: 'entities.sysdepartment.main_grid.columns.updatedate',
            show: true,
            unit: 'px',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'orgid',
            label: '单位',
            langtag: 'entities.sysdepartment.main_grid.columns.orgid',
            show: false,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'pdeptid',
            label: '上级部门',
            langtag: 'entities.sysdepartment.main_grid.columns.pdeptid',
            show: false,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'leaderid',
            label: '分管领导标识',
            langtag: 'entities.sysdepartment.main_grid.columns.leaderid',
            show: false,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules(){
        return {
            srfkey: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdepartment.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysdepartment.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
        }
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView'+(this.$t('app.gridpage.notConfig.fetchAction') as string) });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView'+(this.$t('app.gridpage.notConfig.removeAction') as string) });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ sysdepartment: _keys }),Object.assign({ sysdepartment: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public afterCreated(){
        ...
        if(AppCenterService && AppCenterService.getMessageCenter()){
            this.appStateEvent = AppCenterService.getMessageCenter().subscribe(({ name, action, data }) =>{
                if(!Object.is(name,"SysDepartment")){
                    return;
                }
    ...
    */
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.sysdepartment,$event.sysdepartment);
        });
    ...
    public setColState() {
        ...
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzrt_web_sysdepartmentgridview_grid_main'});
    ...
    public getColStorage() {
        const _data: any = localStorage.getItem('sys_dept_main_grid');
        if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('sys_dept_main_grid', JSON.stringify(this.allColumns));
    }
    ...
    public saveDynaConfig() {
        const viewParams: any = Util.deepCopy(this.viewparams);
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzrt_web_sysdepartmentgridview_grid_main', model: this.allColumns});
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView'+(this.$t('app.gridpage.notConfig.createAction') as string) });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView'+(this.$t('app.gridpage.notConfig.updateAction') as string) });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.sysdepartment){
                            Object.assign(this.context,{sysdepartment:item.sysdepartment});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView'+(this.$t('app.gridpage.notConfig.loaddraftAction') as string) });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.sysdepartment,args.row.sysdepartment);
        });
