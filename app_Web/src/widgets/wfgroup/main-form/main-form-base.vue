...
, 
        groupname: new FormItemModel({ caption: '组名称', detailType: 'FORMITEM', name: 'groupname', visible: true, isShowCaption: true, form: this, isControlledContent: false , disabled: false, enableCond: 3 })
, 
        groupscope: new FormItemModel({ caption: '范围', detailType: 'FORMITEM', name: 'groupscope', visible: true, isShowCaption: true, form: this, isControlledContent: false , disabled: false, enableCond: 3 })
, 
