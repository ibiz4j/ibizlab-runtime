...
, 
        n_groupname_like: new FormItemModel({ caption: '组名称(文本包含(%))', detailType: 'FORMITEM', name: 'n_groupname_like', visible: true, isShowCaption: true, form: this,required:false, disabled: false, enableCond: 3 })
, 
    };
    ...
    public rules: any = {
        n_groupname_like: [
            ...
            { required: this.detailsModel.n_groupname_like.required, type: 'string', message: '组名称(文本包含(%)) 值不能为空', trigger: 'change' },
            { required: this.detailsModel.n_groupname_like.required, type: 'string', message: '组名称(文本包含(%)) 值不能为空', trigger: 'blur' },
        ],
    }
