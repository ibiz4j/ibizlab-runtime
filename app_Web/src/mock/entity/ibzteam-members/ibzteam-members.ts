...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ibzrt-app-web\/ibzteammembers\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ibzrt-app-web\/ibzteammembers\/process-definitions-nodes$/)).reply((config: any) => {
...
// Select
mock.onGet(new RegExp(/^\/ibzorganizations\/([a-zA-Z0-9\-\;]{1,35})\/ibzdepartments\/([a-zA-Z0-9\-\;]{1,35})\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    ...
    const matchArray:any = new RegExp(/^\/ibzorganizations\/([a-zA-Z0-9\-\;]{1,35})\/ibzdepartments\/([a-zA-Z0-9\-\;]{1,35})\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
...
// Select
mock.onGet(new RegExp(/^\/ibzorganizations\/([a-zA-Z0-9\-\;]{1,35})\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: Select");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const matchArray:any = new RegExp(/^\/ibzorganizations\/([a-zA-Z0-9\-\;]{1,35})\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Select
mock.onGet(new RegExp(/^\/ibzteams\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: Select");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// Select
mock.onGet(new RegExp(/^\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: Select");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const matchArray:any = new RegExp(/^\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/select$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// CheckKey
mock.onPost(new RegExp(/^\/ibzorganizations\/([a-zA-Z0-9\-\;]{1,35})\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['orgid','userid','teammemberid'];
    const matchArray:any = new RegExp(/^\/ibzorganizations\/([a-zA-Z0-9\-\;]{1,35})\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// CheckKey
mock.onPost(new RegExp(/^\/ibzteams\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
...
// CheckKey
mock.onPost(new RegExp(/^\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['userid','teammemberid'];
    const matchArray:any = new RegExp(/^\/ibzemployees\/([a-zA-Z0-9\-\;]{1,35})\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// CheckKey
mock.onPost(new RegExp(/^\/ibzteammembers\/?([a-zA-Z0-9\-\;]{0,35})\/checkkey$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: CheckKey");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
    ...
    const paramArray:Array<any> = ['teammemberid'];
    const matchArray:any = new RegExp(/^\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})\/checkkey$/).exec(config.url);
    let tempValue: any = {};
    if(matchArray && matchArray.length >1 && paramArray && paramArray.length >0){
        paramArray.forEach((item: any, index: number) => {
            Object.defineProperty(tempValue, item, {
...
// Get
mock.onGet(new RegExp(/^\/ibzteammembers\/([a-zA-Z0-9\-\;]{1,35})$/)).reply((config: any) => {
    console.groupCollapsed("实体:ibzteammember 方法: Get");
    console.table({url:config.url, method: config.method, data:config.data});
    let status = MockAdapter.mockStatus(config);
    if (status !== 200) {
