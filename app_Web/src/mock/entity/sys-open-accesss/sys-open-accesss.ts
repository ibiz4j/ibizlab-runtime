...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ibzrt-app-web\/sysopenaccesses\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ibzrt-app-web\/sysopenaccesses\/process-definitions-nodes$/)).reply((config: any) => {
