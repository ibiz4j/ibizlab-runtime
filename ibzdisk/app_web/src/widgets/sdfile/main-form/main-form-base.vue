<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sdfile_main' style="">
...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.filename.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.filesize.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.filesize.disabled" 
    type='number' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.fileext.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <input-box 
    v-model="data.fileext"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.fileext.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.folder.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.folder.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.digestcode.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <input-box 
    v-model="data.digestcode"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.digestcode.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.ownerid.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.ownerid.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.ownertype.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <input-box 
    v-model="data.ownertype"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.ownertype.disabled" 
    type='text' 
    style="">
</input-box>
...
<app-span name='createman' :value="data.createman" tag='SysOperator' codelistType='DYNAMIC' :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style="">  
</app-span>
...
<app-span name='createdate' :value="data.createdate" valueFormat="%1$tY-%1$tm-%1$td %1$tH:%1$tM:%1$tS" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style="">  
</app-span>
...
<app-span name='updateman' :value="data.updateman" tag='SysOperator' codelistType='DYNAMIC' :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style="">  
</app-span>
...
<app-span name='updatedate' :value="data.updatedate" valueFormat="%1$tY-%1$tm-%1$td %1$tH:%1$tM:%1$tS" :data="data" :context="context" :viewparams="viewparams" :localContext ='{ }'  :localParam ='{ }'  style="">  
</app-span>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '文件基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, isControlledContent: false , uiActionGroup: { caption: '', langbase: 'entities.sdfile.main_form', extractMode: 'ITEM', details: [] }, isManageContainer: false, showMoreModeItems: []  })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'sdfile_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SDFileEditView' + (this.$t('app.formpage.notconfig.loadaction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SDFileEditView' + (this.$t('app.formpage.notconfig.loaddraftaction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SDFileEditView' + (this.$t('app.formpage.notconfig.actionname') as string) });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SDFileEditView' + (this.$t('app.formpage.notconfig.removeaction') as string) });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
