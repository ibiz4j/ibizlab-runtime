<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sdfile_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "filename";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.sdfile});
        }
        if (this.viewState) {
