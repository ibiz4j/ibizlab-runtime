<template>
<div class="index_view sdindex-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sdindexview"></app-studioaction>
...
export default class SDIndexViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'app.views.sdindexview.caption',
        srfTitle: 'app.views.sdindexview.title',
        srfSubTitle: 'app.views.sdindexview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sdindex-view',tag:this.viewtag,srfkey:isNew ? null : null,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sdindex-view',tag:this.viewtag,srfkey:null,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SDIndexView')){
                    return;
                }
    ...
    public afterMounted(){
        ...
        this.$viewTool.setIndexParameters([{ pathName: 'sdindexview', parameterName: 'sdindexview' }]);
