...
public class StaticDict {
    ...
    public enum AppType {
        INNER("INNER","内置应用"),
        THIRD_SUB_PARTY("THIRD-PARTY","第三方应用");
    ...
    public enum CLSourceType {
        ...
        CLSourceType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    }
    ...
    public enum CLAuthCode {
        ...
        CLAuthCode(String value , String text) {
            this.value=value;
            this.text = text;
        }
    }
    ...
    public enum DE_PERMISSION {
        ...
        DE_PERMISSION(String value , String text) {
            this.value=value;
            this.text = text;
        }
    }
    ...
    public enum CLIBZSex {
        ...
        CLIBZSex(String value , String text) {
            this.value=value;
            this.text = text;
        }
    }
    ...
    public enum CLPermissionType {
        ...
        CLPermissionType(String value , String text) {
            this.value=value;
            this.text = text;
        }
    }
