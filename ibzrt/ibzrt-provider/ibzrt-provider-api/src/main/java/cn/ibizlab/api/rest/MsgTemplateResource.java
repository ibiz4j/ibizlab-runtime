...
public class MsgTemplateResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgTemplate-Create-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgTemplate-Get-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgTemplate-Remove-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgTemplate-Update-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgTemplate-Save-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgTemplate-searchDefault-all')")
