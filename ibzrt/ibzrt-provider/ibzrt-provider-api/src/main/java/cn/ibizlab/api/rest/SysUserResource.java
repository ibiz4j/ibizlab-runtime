...
public class SysUserResource {
    ...
    @PreAuthorize("hasPermission(this.sysuserMapping.toDomain(#sysuserdto),'ibzrt-SysUser-Create')")
    ...
    @PreAuthorize("hasPermission(this.sysuserMapping.toDomain(#sysuserdtos),'ibzrt-SysUser-Create')")
    ...
    @PreAuthorize("hasPermission(this.sysuserService.getSysuserByEntities(this.sysuserMapping.toDomain(#sysuserdtos)),'ibzrt-SysUser-Update')")
    ...
    @PreAuthorize("hasPermission(this.sysuserMapping.toDomain(#sysuserdtos),'ibzrt-SysUser-Save')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-SysUser-searchDefault-all') and hasPermission(#context,'ibzrt-SysUser-Get')")
