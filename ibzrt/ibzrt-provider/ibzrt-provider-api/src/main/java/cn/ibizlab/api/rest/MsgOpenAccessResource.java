...
public class MsgOpenAccessResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgOpenAccess-Create-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgOpenAccess-Get-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgOpenAccess-Remove-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgOpenAccess-Update-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgOpenAccess-Save-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-MsgOpenAccess-searchDefault-all')")
