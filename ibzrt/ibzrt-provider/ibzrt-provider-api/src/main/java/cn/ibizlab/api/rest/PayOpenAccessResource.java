...
public class PayOpenAccessResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-PayOpenAccess-Create-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzrt-PayOpenAccess-searchDefault-all')")
