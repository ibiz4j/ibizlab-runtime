<template>
<div class="index_view notify-index-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="notifyindexview"></app-studioaction>
                ...
                <header class="index_header">
                    <div class="header-left" >
                        <div class="page-logo">
                            ...
                            <app-breadcrumb  :navModel="navModel" indexViewTag="notify-index-view"></app-breadcrumb>
                        </div>
                    </div>
...
export default class NotifyIndexViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'app.views.notifyindexview.caption',
        srfTitle: 'app.views.notifyindexview.title',
        srfSubTitle: 'app.views.notifyindexview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'notify-index-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'NotifyIndexView')){
                    return;
                }
    ...
    public afterMounted(){
        ...
        this.$viewTool.setIndexParameters([{ pathName: 'notifyindexview', parameterName: 'notifyindexview' }]);
