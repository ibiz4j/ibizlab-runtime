...
export default class MsgOpenAccessPickupViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.msgopenaccess.views.pickupview.caption',
        srfTitle: 'entities.msgopenaccess.views.pickupview.title',
        srfSubTitle: 'entities.msgopenaccess.views.pickupview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'msg-open-access-pickup-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'MsgOpenAccessPickupView')){
                    return;
                }
...
<style lang='less'>
@import './msg-open-access-pickup-view.less';
</style>