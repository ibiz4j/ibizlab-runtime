  ...
  <row>
    <i-col span="20" class="form-content">
      <row>
              ...
              <app-form-item name='n_accessname_like' :itemRules="this.rules.n_accessname_like" class='' :caption="$t('entities.msgopenaccess.default_searchform.details.n_accessname_like')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.n_accessname_like.error" :isEmptyCaption="false" labelPos="LEFT"> 
              <input-box 
          ...
          <i-col v-show="detailsModel.n_open_type_eq.visible" :style="{}"  :sm="{ span: 24, offset: 0 }" :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
              <app-form-item name='n_open_type_eq' :itemRules="this.rules.n_open_type_eq" class='' :caption="$t('entities.msgopenaccess.default_searchform.details.n_open_type_eq')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.n_open_type_eq.error" :isEmptyCaption="false" labelPos="LEFT"> 
...
, 
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'MsgOpenAccessGridView' + (this.$t('app.searchForm.notConfig.loadAction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {},mode?:string): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'MsgOpenAccessGridView' + (this.$t('app.searchForm.notConfig.loaddraftAction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        Object.assign(arg,{viewparams:this.viewparams});
