<template>
    ...
    <app-form-item name='accessname' :itemRules="this.rules().accessname" class='' :caption="$t('entities.msgopenaccess.main_form.details.accessname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.accessname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.open_type.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='open_type' :itemRules="this.rules().open_type" class='' :caption="$t('entities.msgopenaccess.main_form.details.open_type')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.open_type.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.access_key.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='access_key' :itemRules="this.rules().access_key" class='' :caption="$t('entities.msgopenaccess.main_form.details.access_key')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.access_key.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.secret_key.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='secret_key' :itemRules="this.rules().secret_key" class='' :caption="$t('entities.msgopenaccess.main_form.details.secret_key')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.secret_key.error" :isEmptyCaption="false" labelPos="LEFT">
...
<i-col v-show="detailsModel.region_id.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='region_id' :itemRules="this.rules().region_id" class='' :caption="$t('entities.msgopenaccess.main_form.details.region_id')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.region_id.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.access_token.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='access_token' :itemRules="this.rules().access_token" class='' :caption="$t('entities.msgopenaccess.main_form.details.access_token')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.access_token.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.expires_time.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='expires_time' :itemRules="this.rules().expires_time" class='' :caption="$t('entities.msgopenaccess.main_form.details.expires_time')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.expires_time.error" :isEmptyCaption="false" labelPos="LEFT">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        region_id: [
            ...
            { required: this.detailsModel.region_id.required, type: 'string', message: 'RegionId（CorpId) 值不能为空', trigger: 'change' },
            { required: this.detailsModel.region_id.required, type: 'string', message: 'RegionId（CorpId) 值不能为空', trigger: 'blur' },
        ],
        access_token: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '接入开放平台基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, isControlledContent: false , uiActionGroup: { caption: '', langbase: 'entities.msgopenaccess.main_form', extractMode: 'ITEM', details: [] }, isManageContainer: false, showMoreModeItems: []  })
, 
...
, 
        region_id: new FormItemModel({ caption: 'RegionId（CorpId)', detailType: 'FORMITEM', name: 'region_id', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        expires_time: new FormItemModel({ caption: '管理账号token过期时间', detailType: 'FORMITEM', name: 'expires_time', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 0 })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'msgopenaccess_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'MsgOpenAccessEditView' + (this.$t('app.formpage.notconfig.loadaction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'MsgOpenAccessEditView' + (this.$t('app.formpage.notconfig.loaddraftaction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'MsgOpenAccessEditView' + (this.$t('app.formpage.notconfig.actionname') as string) });
            return;
        }
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'MsgOpenAccessEditView' + (this.$t('app.formpage.notconfig.removeaction') as string) });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.msgopenaccess || Object.is(arg.msgopenaccess, '')) {
            return;
        }
