        ...
        app: {
            ...
            views: {
                notifyindexview: {
                    ...
                    title: commonLogic.appcommonhandle("notify",null),
                },
            },
            utilview:{
                importview:"导入数据",
            ...
            menus: {
                notifyindexview: {
                    menuitem1: commonLogic.appcommonhandle("接入第三方平台",null),
                    menuitem2: commonLogic.appcommonhandle("消息模板",null),
                    menuitem3: commonLogic.appcommonhandle("消息账户",null),
                },
            },
            formpage:{
