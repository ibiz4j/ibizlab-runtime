...
module.exports = {
    ...
    outputDir:"../ibznotify-app/ibznotify-app-web/target/classes/META-INF/resources",
    devServer: {
        host: '0.0.0.0',
        port: 8111,
        compress: true,
        ...
        historyApiFallback: {
            rewrites: [
               // { from: /^\/notifyindexview$/, to: '/notifyindexview.html' },
            ]
        }
    },
    pages: {
        ...
        index : {
            // page 的入口
            entry: 'src/pages/notify/notify-index-view/main.ts',
            // 模板来源
    ...
    chainWebpack: (config) => {
        config.plugins.delete('preload-notifyindexview')
        config.plugins.delete('prefetch-notifyindexview')
