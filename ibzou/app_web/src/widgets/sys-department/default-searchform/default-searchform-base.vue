  ...
  <row>
    <i-col span="20" class="form-content">
      <row>
              ...
              <app-form-item name='n_deptcode_like' :itemRules="this.rules.n_deptcode_like" class='' :caption="$t('entities.sysdepartment.default_searchform.details.n_deptcode_like')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.n_deptcode_like.error" :isEmptyCaption="false" labelPos="LEFT"> 
              <input-box 
              v-model="data.n_deptcode_like"  
              @enter="onEnter($event)"  
                
              :disabled="detailsModel.n_deptcode_like.disabled" 
              type='text' 
              style="width:100px;">
          </input-box>
          ...
          <i-col v-show="detailsModel.n_deptname_like.visible" :style="{}"  :sm="{ span: 12, offset: 0 }" :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 8, offset: 0 }">
              <app-form-item name='n_deptname_like' :itemRules="this.rules.n_deptname_like" class='' :caption="$t('entities.sysdepartment.default_searchform.details.n_deptname_like')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.n_deptname_like.error" :isEmptyCaption="false" labelPos="LEFT"> 
              <input-box 
              v-model="data.n_deptname_like"  
              @enter="onEnter($event)"  
                
              :disabled="detailsModel.n_deptname_like.disabled" 
              type='text' 
              style="width:100px;">
          </input-box>
          ...
          <i-col v-show="detailsModel.n_bcode_like.visible" :style="{}"  :sm="{ span: 12, offset: 0 }" :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 8, offset: 0 }">
              <app-form-item name='n_bcode_like' :itemRules="this.rules.n_bcode_like" class='' :caption="$t('entities.sysdepartment.default_searchform.details.n_bcode_like')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.n_bcode_like.error" :isEmptyCaption="false" labelPos="LEFT"> 
              <input-box 
              v-model="data.n_bcode_like"  
              @enter="onEnter($event)"  
                
              :disabled="detailsModel.n_bcode_like.disabled" 
              type='text' 
              style="width:100px;">
          </input-box>
...
, 
     ...
     * @memberof DefaultBase
     */
    @Watch('data.n_deptcode_like')
    onN_deptcode_likeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_deptcode_like', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 n_deptname_like 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof DefaultBase
     */
    @Watch('data.n_deptname_like')
    onN_deptname_likeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_deptname_like', newVal: newVal, oldVal: oldVal });
    }
     ...
     * @memberof DefaultBase
     */
    @Watch('data.n_orgid_eq')
    onN_orgid_eqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_orgid_eq', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 n_pdeptid_eq 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof DefaultBase
     */
    @Watch('data.n_pdeptid_eq')
    onN_pdeptid_eqChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_pdeptid_eq', newVal: newVal, oldVal: oldVal });
    }
     ...
     * @memberof DefaultBase
     */
    @Watch('data.n_bcode_like')
    onN_bcode_likeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_bcode_like', newVal: newVal, oldVal: oldVal });
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView' + (this.$t('app.searchForm.notConfig.loadAction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {},mode?:string): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysDepartmentGridView' + (this.$t('app.searchForm.notConfig.loaddraftAction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        Object.assign(arg,{viewparams:this.viewparams});
