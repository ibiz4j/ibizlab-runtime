    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('deptcode')">
                <el-table-column show-overflow-tooltip :prop="'deptcode'" :label="$t('entities.sysdepartment.main_grid.columns.deptcode')" :width="130"  :align="'left'" :sortable="'custom'">
            ...
            <template v-if="getColumnState('deptname')">
                <el-table-column show-overflow-tooltip :prop="'deptname'" :label="$t('entities.sysdepartment.main_grid.columns.deptname')" :width="240"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('orgname')">
                <el-table-column show-overflow-tooltip :prop="'orgname'" :label="$t('entities.sysdepartment.main_grid.columns.orgname')" :width="240"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('pdeptname')">
                <el-table-column show-overflow-tooltip :prop="'pdeptname'" :label="$t('entities.sysdepartment.main_grid.columns.pdeptname')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('deptlevel')">
                <el-table-column show-overflow-tooltip :prop="'deptlevel'" :label="$t('entities.sysdepartment.main_grid.columns.deptlevel')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('shortname')">
                <el-table-column show-overflow-tooltip :prop="'shortname'" :label="$t('entities.sysdepartment.main_grid.columns.shortname')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('bcode')">
                <el-table-column show-overflow-tooltip :prop="'bcode'" :label="$t('entities.sysdepartment.main_grid.columns.bcode')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('leadername')">
                <el-table-column show-overflow-tooltip :prop="'leadername'" :label="$t('entities.sysdepartment.main_grid.columns.leadername')" :width="130"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('showorder')">
                <el-table-column show-overflow-tooltip :prop="'showorder'" :label="$t('entities.sysdepartment.main_grid.columns.showorder')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
