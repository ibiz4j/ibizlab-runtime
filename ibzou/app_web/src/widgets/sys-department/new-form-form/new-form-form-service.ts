...
export default class NewFormService extends ControlService {
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        ...
        if (Object.is(serviceName, 'SysDepartmentService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.appEntityService.FetchDefault(JSON.parse(JSON.stringify(context)), data, isloading), 'deptid', 'sysdepartment');
        }
