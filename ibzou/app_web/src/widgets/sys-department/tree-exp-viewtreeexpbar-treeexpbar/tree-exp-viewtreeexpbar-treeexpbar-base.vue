...
export default class TreeExpViewtreeexpbarBase extends Vue implements ControlInterface {
    ...
    public getExpItemView(arg: any = {}): any {
        ...
        if (Object.is(expmode, 'DEPT')) {
            return {  
                viewname: 'sys-employee-grid-view', 
                parentdata: {"srfparentdefname":"MDEPTID","srfparentdename":"SYS_DEPT","srfparentmode":"DER1N_SYS_EMP_SYS_DEPT_MDEPTID"},
