        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('usercode')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='usercode' editorType="TEXTBOX" :value="row.usercode"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('personname')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='personname' editorType="TEXTBOX" :value="row.personname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('loginname')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='loginname' editorType="TEXTBOX" :value="row.loginname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            ...
            <template v-if="getColumnState('mdeptname')">
              ...
              @formitemvaluechange="($event)=>{onGridItemValueChange(row,$event,$index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='mdeptname' editorType="PICKER" :value="row.mdeptname"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            ...
            <template v-if="getColumnState('phone')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='phone' editorType="TEXTBOX" :value="row.phone"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('ipaddr')">
              ...
              @change="($event)=>{gridEditItemChange(row, column.property, $event, $index)}">
                        ...
                        <template v-if="!actualIsOpenEdit">
                                <app-span name='ipaddr' editorType="TEXTBOX" :value="row.ipaddr"></app-span>
                        </template>
                    </template>
                </el-table-column>
            </template>
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'usercode',
            label: '用户工号',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.usercode',
            show: true,
            util: 'px'
        },
        {
            name: 'personname',
            label: '姓名',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.personname',
            show: true,
            util: 'px'
        },
        {
            name: 'loginname',
            label: '登录名',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.loginname',
            show: true,
            util: 'px'
        },
        {
            name: 'orgcode',
            label: '单位代码',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.orgcode',
            show: true,
            util: 'px'
        },
        {
            name: 'orgname',
            label: '单位名称',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.orgname',
            show: true,
            util: 'px'
        },
        {
            name: 'mdeptcode',
            label: '主部门代码',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.mdeptcode',
            show: true,
            util: 'px'
        },
        {
            name: 'mdeptname',
            label: '主部门名称',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.mdeptname',
            show: true,
            util: 'px'
        },
        {
            name: 'sex',
            label: '性别',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.sex',
            show: true,
            util: 'px'
        },
        {
            name: 'phone',
            label: '联系方式',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.phone',
            show: true,
            util: 'px'
        },
        {
            name: 'ipaddr',
            label: 'ip地址',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.ipaddr',
            show: true,
            util: 'px'
        },
        {
            name: 'showorder',
            label: '排序',
            langtag: 'entities.ibzemployee.editgrid_grid.columns.showorder',
            show: true,
            util: 'px'
        },
    ]
    ...
    public getGridRowModel(){
        return {
          ...
          ipaddr: new FormItemModel(),
          orgid: new FormItemModel(),
          usercode: new FormItemModel(),
          orgname: new FormItemModel(),
          mdeptid: new FormItemModel(),
    ...
    public rules: any = {
        loginname: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '登录名 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '登录名 值不能为空', trigger: 'blur' },
        ],
        phone: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '联系方式 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '联系方式 值不能为空', trigger: 'blur' },
        ],
        sex: [
        ...
        ipaddr: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: 'ip地址 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: 'ip地址 值不能为空', trigger: 'blur' },
        ],
        orgid: [
        ...
        usercode: [
             { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '用户工号 值不能为空', trigger: 'change' },
            { required: true, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '用户工号 值不能为空', trigger: 'blur' },
        ],
        orgname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '单位名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '单位名称 值不能为空', trigger: 'blur' },
        ],
        mdeptid: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '值不能为空', trigger: 'blur' },
        ...
        mdeptname: [
             { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '主部门名称 值不能为空', trigger: 'change' },
            { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: '主部门名称 值不能为空', trigger: 'blur' },
        ],
        personname: [
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: '错误', desc: 'IBZEmployeeEditGridView视图表格fetchAction参数未配置' });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: '错误', desc: 'IBZEmployeeEditGridView视图表格removeAction参数未配置' });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ ibzemployee: _keys }),Object.assign({ ibzemployee: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.ibzemp,$event.ibzemp);
        });
     ...
     */
    public setColState() {
		const _data: any = localStorage.getItem('ibzemp_editgrid_grid');
		if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('ibzemp_editgrid_grid', JSON.stringify(this.allColumns));
    }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: '错误', desc: 'IBZEmployeeEditGridView视图表格loaddraftAction参数未配置' });
            return;
        }
        let _this = this;
