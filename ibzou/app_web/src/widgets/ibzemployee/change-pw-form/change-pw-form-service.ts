...
import ChangePwModel from './change-pw-form-model';
 ...
 */
export default class ChangePwService extends ControlService {
    ...
    /**
     * Creates an instance of ChangePwService.
     * 
     * @param {*} [opts={}]
     * @memberof ChangePwService
     */
