<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysorganization_main' style="">
    <input style="display:none;" />
    <row >
            <i-col v-show="detailsModel.orgcode.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='orgcode' :itemRules="this.rules().orgcode" class='' :caption="$t('entities.sysorganization.main_form.details.orgcode')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.orgcode.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.orgname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='orgname' :itemRules="this.rules().orgname" class='' :caption="$t('entities.sysorganization.main_form.details.orgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.orgname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.porgname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='porgname' :itemRules="this.rules().porgname" class='' :caption="$t('entities.sysorganization.main_form.details.porgname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.porgname.error" :isEmptyCaption="false" labelPos="LEFT">
    <app-org-select :data="data" :disabled="detailsModel.porgname.disabled" :context="JSON.parse(JSON.stringify(context))" :fillMap="{'id':'porgid','label':'porgname'}" url="/sys_organizations/alls/suborg/picker" filter="srforgid" :multiple="false" style="" @select-change="onFormItemValueChange" ></app-org-select>
</app-form-item>

</i-col>
<i-col v-show="detailsModel.orglevel.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='orglevel' :itemRules="this.rules().orglevel" class='' :caption="$t('entities.sysorganization.main_form.details.orglevel')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.orglevel.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
    v-model="data.orglevel"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.orglevel.disabled" 
    type='number' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.shortname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='shortname' :itemRules="this.rules().shortname" class='' :caption="$t('entities.sysorganization.main_form.details.shortname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.shortname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
<i-col v-show="detailsModel.showorder.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-item name='showorder' :itemRules="this.rules().showorder" class='' :caption="$t('entities.sysorganization.main_form.details.showorder')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.showorder.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        orglevel: [
            { required: this.detailsModel.orglevel.required, type: 'number', message: '单位级别 值不能为空', trigger: 'change' },
            { required: this.detailsModel.orglevel.required, type: 'number', message: '单位级别 值不能为空', trigger: 'blur' },
        ],
        shortname: [
            { required: this.detailsModel.shortname.required, type: 'string', message: '单位简称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.shortname.required, type: 'string', message: '单位简称 值不能为空', trigger: 'blur' },
        ],
        showorder: [
...
, 
        porgname: new FormItemModel({ caption: '上级单位', detailType: 'FORMITEM', name: 'porgname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 1 })
, 
        orglevel: new FormItemModel({ caption: '单位级别', detailType: 'FORMITEM', name: 'orglevel', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'sysorganization_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOrganizationEditView' + (this.$t('app.formpage.notconfig.loadaction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOrganizationEditView' + (this.$t('app.formpage.notconfig.loaddraftaction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOrganizationEditView' + (this.$t('app.formpage.notconfig.actionname') as string) });
            return;
        }
    ...
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOrganizationEditView' + (this.$t('app.formpage.notconfig.removeaction') as string) });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
