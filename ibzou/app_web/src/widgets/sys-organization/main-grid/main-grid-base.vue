    ...
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('orgname')">
                <el-table-column show-overflow-tooltip :prop="'orgname'" :label="$t('entities.sysorganization.main_grid.columns.orgname')" :width="240"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('orglevel')">
                <el-table-column show-overflow-tooltip :prop="'orglevel'" :label="$t('entities.sysorganization.main_grid.columns.orglevel')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('porgname')">
                <el-table-column show-overflow-tooltip :prop="'porgname'" :label="$t('entities.sysorganization.main_grid.columns.porgname')" :width="240"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('porgid')">
                <el-table-column show-overflow-tooltip :prop="'porgid'" :label="$t('entities.sysorganization.main_grid.columns.porgid')" :width="240"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
            ...
            <template v-if="getColumnState('showorder')">
                <el-table-column show-overflow-tooltip :prop="'showorder'" :label="$t('entities.sysorganization.main_grid.columns.showorder')" :width="120"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
