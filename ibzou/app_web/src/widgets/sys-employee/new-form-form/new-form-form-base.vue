<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysemployee_newform' style="" @on-validate="formItemValidate">
...
<i-col v-show="detailsModel.mdeptname.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    <app-department-select :data="data" :disabled="detailsModel.mdeptname.disabled" :context="JSON.parse(JSON.stringify(context))" url="/sysorganizations/${orgid}/sysdepartments/picker" filter="orgid"  :fillMap="{'id':'mdeptid','label':'mdeptname'}" :multiple="false" style="" @select-change="onFormItemValueChange" ></app-department-select>
</app-form-item>
