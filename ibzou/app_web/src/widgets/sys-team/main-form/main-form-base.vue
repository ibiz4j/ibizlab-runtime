<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='systeam_main' style="" @on-validate="formItemValidate">
...
import SysTeamEntityService from '@/service/sys-team/sys-team-service';
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: SysTeamEntityService = new SysTeamEntityService({ $store: this.$store });
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "teamname";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.systeam});
        }
        if (this.viewState) {
