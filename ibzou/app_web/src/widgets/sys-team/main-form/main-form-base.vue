<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='systeam_main' style="">
    <input style="display:none;" />
    <row >
            
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group :uiService="appUIService" :data="transformData(data)" :manageContainerStatus="detailsModel.group1.manageContainerStatus"  :isManageContainer="detailsModel.group1.isManageContainer" @managecontainerclick="manageContainerClick('group1')" layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.systeam.main_form.details.group1')" :isShowCaption="false" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
    ...
    <app-form-item name='teamname' :itemRules="this.rules().teamname" class='' :caption="$t('entities.systeam.main_form.details.teamname')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.teamname.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
    v-model="data.teamname"  
    @enter="onEnter($event)"  
     unit=""  
    :disabled="detailsModel.teamname.disabled" 
    type='text' 
    style="">
</input-box>
...
<i-col v-show="detailsModel.memo.visible" :style="{}"  :sm="{ span: 24, offset: 0 }" :md="{ span: 12, offset: 0 }" :lg="{ span: 12, offset: 0 }" :xl="{ span: 12, offset: 0 }">
    <app-form-item name='memo' :itemRules="this.rules().memo" class='' :caption="$t('entities.systeam.main_form.details.memo')" uiStyle="DEFAULT" :labelWidth="130" :isShowCaption="true" :error="detailsModel.memo.error" :isEmptyCaption="false" labelPos="LEFT">
    <input-box 
    v-model="data.memo"  
    @enter="onEnter($event)"  
     unit=""  
...
<i-col v-show="detailsModel.grouppanel1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    ...
    paramItem='systeam' 
    :parentdata='{"srfparentdefname":"TEAMID","srfparentdename":"SYS_TEAM","SRFPARENTTYPE":"DER1N","srfparentmode":"DER1N_SYS_TEAMMEMBER_SYS_TEAM_TEAMID","SRFDER1NID":"DER1N_SYS_TEAMMEMBER_SYS_TEAM_TEAMID"}'
    :parameters="[
    ...
    :localContext ='{}'
    :localParam ='{}'
    parameterName='systeam'
    parentName="SysTeam"  
    refviewtype='DEGRIDVIEW' 
    refreshitems='' 
    :ignorefieldvaluechange="ignorefieldvaluechange"
    viewname='sys-team-member-grid-view'
    tempMode='0'
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        teamname: [
            { type: 'string', message: '组名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '组名称 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.teamname.required, type: 'string', message: '组名称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.teamname.required, type: 'string', message: '组名称 值不能为空', trigger: 'blur' },
        ],
        memo: [
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '组基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, isControlledContent: false , uiActionGroup: { caption: '', langbase: 'entities.systeam.main_form', extractMode: 'ITEM', details: [] }, isManageContainer: false, showMoreModeItems: []  })
, 
...
, 
        grouppanel1: new FormGroupPanelModel({ caption: '组成员', detailType: 'GROUPPANEL', name: 'grouppanel1', visible: true, isShowCaption: false, form: this, isControlledContent: false , uiActionGroup: { caption: '', langbase: 'entities.systeam.main_form', extractMode: 'ITEM', details: [] }, isManageContainer: false, showMoreModeItems: []  })
, 
...
, 
        srfkey: new FormItemModel({ caption: '组标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '组名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        teamname: new FormItemModel({ caption: '组名称', detailType: 'FORMITEM', name: 'teamname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:true, disabled: false, enableCond: 3 })
, 
...
, 
    ...
    public onFormLoad(data: any = {},action:string): void {
        ...
        // 更新context的实体主键
        if(data.systeam){
            Object.assign(this.context,{systeam:data.systeam})
        }
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'systeam_main',popTitle:'主编辑表单'});
    }
    ...
    public load(opt: any = {}): void {
        if(!this.loadAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamEditView' + (this.$t('app.formpage.notconfig.loadaction') as string) });
            return;
        }
        const arg: any = { ...opt };
    ...
    public loadDraft(opt: any = {}): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamEditView' + (this.$t('app.formpage.notconfig.loaddraftaction') as string) });
            return;
        }
        const arg: any = { ...opt } ;
        let viewparamResult:any = Object.assign(arg,this.viewparams);
    ...
    public autoSave(opt: any = {}): void {
        ...
        if(!action){
            ...
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamEditView' + (this.$t('app.formpage.notconfig.actionname') as string) });
            return;
        }
        ...
        post.then((response: any) => {
            ...
            this.$emit('save', data);
            AppCenterService.notifyMessage({name:"SysTeam",action:'appRefresh',data:data});
            this.$nextTick(() => {
    ...
    */
    public remove(opt:Array<any> = [],showResultInfo?: boolean): Promise<any> {
        return new Promise((resolve: any, reject: any) => {
            if(!this.removeAction){
                this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysTeamEditView' + (this.$t('app.formpage.notconfig.removeaction') as string) });
                return;
            }
            const arg: any = opt[0];
            const _this: any = this;
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.systeam || Object.is(arg.systeam, '')) {
            return;
        }
