...
<div class="app-app-menu">
    <el-menu
      ...
      :default-active="defaultActive">
        ...
        <app-menu-item v-else :isCollapse="isCollapse" :menus="menus" :ctrlName="'ouindexview'" :isFirst="true" :counterdata="counterdata" :popper-class="popperClass"></app-menu-item>
    </el-menu>
</div>
</template>
