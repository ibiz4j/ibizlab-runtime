...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '部门成员基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: false, form: this, uiActionGroup: { caption: '', langbase: 'entities.ibzdeptmember.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfmajortext: new FormItemModel({ caption: '成员', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        personname: new FormItemModel({ caption: '成员', detailType: 'FORMITEM', name: 'personname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        memberid: new FormItemModel({ caption: '标识', detailType: 'FORMITEM', name: 'memberid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
