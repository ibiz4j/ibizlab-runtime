<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='syspost_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "postname";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.syspost});
        }
        if (this.viewState) {
