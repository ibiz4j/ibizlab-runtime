<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='systeammember_main' style="" @on-validate="formItemValidate">
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.systeammember});
        }
        if (this.viewState) {
