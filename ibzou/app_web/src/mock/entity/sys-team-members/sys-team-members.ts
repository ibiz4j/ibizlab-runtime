...
//getwflink
mock.onGet(new RegExp(/^\/wfcore\/ibzou-app-web\/systeammembers\/[a-zA-Z0-9\-\;]+\/usertasks\/[a-zA-Z0-9\-\;]+\/ways$/)).reply((config: any) => {
...
// getwfstep
mock.onGet(new RegExp(/^\/wfcore\/ibzou-app-web\/systeammembers\/process-definitions-nodes$/)).reply((config: any) => {
