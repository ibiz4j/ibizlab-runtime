 ...
 */
export default class IBZPostUIServiceBase extends UIService {
     ...
     * @memberof  IBZPostUIServiceBase
     */
    public dataService:IBZPostService = new IBZPostService();
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new IBZPostAuthService(opts);
        this.initViewMap();
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({ibzpost:srfkey});
