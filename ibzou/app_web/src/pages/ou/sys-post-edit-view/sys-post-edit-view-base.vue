    ...
    <div class='toolbar-container'>
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem7.visabled" :disabled="toolBarModels.tbitem7.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem7' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.syspost.editviewtoolbar_toolbar.tbitem7.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.syspost.editviewtoolbar_toolbar.tbitem7.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>
        <tooltip :transfer="true" :max-width="600">
