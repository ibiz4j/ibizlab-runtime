<template>
<div class="view-container dempickupview ibzdepartment-mpickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzdepartmentmpickupview"></app-studioaction>
...
export default class IBZDepartmentMPickupViewBase extends Vue {
	 ...
	 * @memberof IBZDepartmentMPickupViewBase
	 */
	public viewtag: string = '95a44e1851d28a16a90965f60d6ff4ae';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ibzdepartment.views.mpickupview.caption',
        srfTitle: 'entities.ibzdepartment.views.mpickupview.title',
        srfSubTitle: 'entities.ibzdepartment.views.mpickupview.subtitle',
        dataInfo: ''
    }
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzdepartment-mpickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzdepartment-mpickup-view',tag:this.viewtag,srfkey:this.context.ibzdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
...
<style lang='less'>
@import './ibzdepartment-mpickup-view.less';
</style>