<template>
<div class='view-container depickupgridview ibzdepartment-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzdepartmentpickupgridview"></app-studioaction>
...
export default class IBZDepartmentPickupGridViewBase extends Vue {
	 ...
	 * @memberof IBZDepartmentPickupGridViewBase
	 */
	public viewtag: string = 'e3284e895913f7d38d1bcbe898bda0b7';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzdepartment-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzdepartment-pickup-grid-view',tag:this.viewtag,srfkey:this.context.ibzdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
...
<style lang='less'>
@import './ibzdepartment-pickup-grid-view.less';
</style>