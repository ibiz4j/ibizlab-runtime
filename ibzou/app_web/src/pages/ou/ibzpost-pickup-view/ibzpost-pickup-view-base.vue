<template>
<div class="view-container depickupview ibzpost-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzpostpickupview"></app-studioaction>
...
export default class IBZPostPickupViewBase extends Vue {
	 ...
	 * @memberof IBZPostPickupViewBase
	 */
	public viewtag: string = '7e3fbce8277ad89674307e6a0d7ddd43';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzpost-pickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzpost,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzpost-pickup-view',tag:this.viewtag,srfkey:this.context.ibzpost,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'ibzpost-pickup-view')){
                return;
            }
...
<style lang='less'>
@import './ibzpost-pickup-view.less';
</style>