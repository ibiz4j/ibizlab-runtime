<template>
<div class="view-container deeditview ibzemployee-change-pwd-view">
...
export default class IBZEmployeeChangePwdViewBase extends Vue {
	 ...
	 * @memberof IBZEmployeeChangePwdViewBase
	 */
	public viewtag: string = 'b752aab6603d699de44f7dc2c8164b9c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ibzemployee.views.changepwdview.caption',
        srfTitle: 'entities.ibzemployee.views.changepwdview.title',
        srfSubTitle: 'entities.ibzemployee.views.changepwdview.subtitle',
        dataInfo: ''
    }
     ...
     *
     * @type {*}
     * @memberof IBZEmployeeChangePwdView
     */
...
<style lang='less'>
@import './ibzemployee-change-pwd-view.less';
</style>