<template>
<div class='view-container depickupgridview ibzorganization-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="ibzorganizationpickupgridview"></app-studioaction>
...
export default class IBZOrganizationPickupGridViewBase extends Vue {
	 ...
	 * @memberof IBZOrganizationPickupGridViewBase
	 */
	public viewtag: string = '4c3fc434585ac656b753c26c1f10482b';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'ibzorganization-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.ibzorganization,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'ibzorganization-pickup-grid-view',tag:this.viewtag,srfkey:this.context.ibzorganization,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
...
<style lang='less'>
@import './ibzorganization-pickup-grid-view.less';
</style>