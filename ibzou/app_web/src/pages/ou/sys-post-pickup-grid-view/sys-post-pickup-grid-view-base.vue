...
export default class SysPostPickupGridViewBase extends Vue {
	 ...
	 * @memberof SysPostPickupGridViewBase
	 */
	public viewtag: string = '65c16575fd8b1fa8bf111e17f573f697';
     ...
     */
    public model: any = {
        srfCaption: 'entities.syspost.views.pickupgridview.caption',
        srfTitle: 'entities.syspost.views.pickupgridview.title',
        srfSubTitle: 'entities.syspost.views.pickupgridview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-post-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.syspost,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-post-pickup-grid-view',tag:this.viewtag,srfkey:this.context.syspost,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-post-pickup-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysPostPickupGridView')){
                    return;
                }
...
<style lang='less'>
@import './sys-post-pickup-grid-view.less';
</style>