                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem1_opennewcreateview.visabled" :disabled="toolBarModels.tbitem1_opennewcreateview.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem1_opennewcreateview' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.sysemployee.gridviewtoolbar_toolbar.tbitem1_opennewcreateview.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.sysemployee.gridviewtoolbar_toolbar.tbitem1_opennewcreateview.tip')}}</div>
                        </tooltip>
                        ...
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.deuiaction1.visabled" :disabled="toolBarModels.deuiaction1.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'deuiaction1' }, $event)">
                                    <i class='fa fa-file-text-o'></i>
                                    <span class='caption'>{{$t('entities.sysemployee.gridviewtoolbar_toolbar.deuiaction1.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.sysemployee.gridviewtoolbar_toolbar.deuiaction1.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
...
export default class SysEmployeeGridViewBase extends Vue {
   ...
   */
    ...
    public toolbar_tbitem1_opennewcreateview_click(params: any = {}, tag?: any, $event?: any) {
        ...
        curUIService.SysEmployee_OpenNewCreateView(datas,contextJO, paramJO,  $event, xData,this,"SysEmployee");
    }
