                    ...
                    <div class='toolbar-container'>
                        <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem24.visabled" :disabled="toolBarModels.tbitem24.disabled" class='' @click="toolbar_click({ tag: 'tbitem24' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem24.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem24.tip')}}</div>
                        </tooltip>
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem25.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem8.visabled" :disabled="toolBarModels.tbitem8.disabled" class='' @click="toolbar_click({ tag: 'tbitem8' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem8.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem8.tip')}}</div>
                        </tooltip>
                        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
                                <i-button v-show="toolBarModels.tbitem19.visabled" :disabled="toolBarModels.tbitem19.disabled" class='' @click="toolbar_click({ tag: 'tbitem19' }, $event)">
                                    ...
                                    <span class='caption'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem19.caption')}}</span>
                                </i-button>
                            <div slot='content'>{{$t('entities.ibzdepartment.editgridviewtoolbar_toolbar.tbitem19.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </div>
...
export default class IBZDepartmentEditGridViewBase extends Vue {
	 ...
	 * @memberof IBZDepartmentEditGridViewBase
	 */
	public viewtag: string = '230a2347ac7bca8734046b14777bc258';
     ...
     */
    public model: any = {
        srfCaption: 'entities.ibzdepartment.views.editgridview.caption',
        srfTitle: 'entities.ibzdepartment.views.editgridview.title',
        srfSubTitle: 'entities.ibzdepartment.views.editgridview.subtitle',
        dataInfo: ''
    }
...
<style lang='less'>
@import './ibzdepartment-edit-grid-view.less';
</style>