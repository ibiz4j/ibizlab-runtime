...
export default class SysDepartmentPickupGridViewBase extends Vue {
	 ...
	 * @memberof SysDepartmentPickupGridViewBase
	 */
	public viewtag: string = '06dc389605323456129e342bbdfbbd16';
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysdepartment.views.pickupgridview.caption',
        srfTitle: 'entities.sysdepartment.views.pickupgridview.title',
        srfSubTitle: 'entities.sysdepartment.views.pickupgridview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-department-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-department-pickup-grid-view',tag:this.viewtag,srfkey:this.context.sysdepartment,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-department-pickup-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysDepartmentPickupGridView')){
                    return;
                }
...
<style lang='less'>
@import './sys-department-pickup-grid-view.less';
</style>