...
export default class SysEmployeeMPickupViewBase extends Vue {
	 ...
	 * @memberof SysEmployeeMPickupViewBase
	 */
	public viewtag: string = 'af7290279f8b7645020401c1beb9269e';
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysemployee.views.mpickupview.caption',
        srfTitle: 'entities.sysemployee.views.mpickupview.title',
        srfSubTitle: 'entities.sysemployee.views.mpickupview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-employee-mpickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysemployee,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-employee-mpickup-view',tag:this.viewtag,srfkey:this.context.sysemployee,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-employee-mpickup-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysEmployeeMPickupView')){
                    return;
                }
...
<style lang='less'>
@import './sys-employee-mpickup-view.less';
</style>