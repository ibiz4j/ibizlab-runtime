...
public class SysPostResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzou-SysPost-Update-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzou-SysPost-Remove-all')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_SUPERADMIN','ibzou-SysPost-Get-all')")
