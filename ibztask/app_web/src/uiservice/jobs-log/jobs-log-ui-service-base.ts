...
export default class JobsLogUIServiceBase extends UIService {
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'jobslogs',component:'jobs-log-grid-view'});
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'jobslogs',component:'jobs-log-edit-view'});
    }
