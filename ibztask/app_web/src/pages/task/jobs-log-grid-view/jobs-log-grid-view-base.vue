...
export default class JobsLogGridViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.jobslog.views.gridview.caption',
        srfTitle: 'entities.jobslog.views.gridview.title',
        srfSubTitle: 'entities.jobslog.views.gridview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'jobs-log-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'JobsLogGridView')){
                    return;
                }
...
<style lang='less'>
@import './jobs-log-grid-view.less';
</style>