                ...
                <div class='pull-right'>
                    <div class='toolbar-container'>
                        ...
                        <tooltip :transfer="true" :max-width="600">
                            ...
                            <div slot='content'>{{$t('entities.jobsinfo.gridviewtoolbar_toolbar.deuiaction7.tip')}}</div>
                        </tooltip>
                    </div>
                </div>
            </div>
...
export default class JobsInfoGridViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.jobsinfo.views.gridview.caption',
        srfTitle: 'entities.jobsinfo.views.gridview.title',
        srfSubTitle: 'entities.jobsinfo.views.gridview.subtitle',
        dataInfo: ''
    }
    ...
    public toolBarModels: any = {
        deuiaction1: { name: 'deuiaction1', actiontarget: 'NONE', caption: '启动', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'Start', target: 'SINGLEKEY' } },

        deuiaction2: { name: 'deuiaction2', actiontarget: 'NONE', caption: '停止', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'Stop', target: 'SINGLEKEY' } },

        deuiaction3: { name: 'deuiaction3', actiontarget: 'NONE', caption: '执行', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'Execute', target: 'SINGLEKEY' } },

        deuiaction4: { name: 'deuiaction4', actiontarget: 'NONE', caption: '新建', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'New', target: '' } },

        deuiaction5: { name: 'deuiaction5', actiontarget: 'NONE', caption: '编辑', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'Edit', target: 'SINGLEKEY' } },

        deuiaction6: { name: 'deuiaction6', actiontarget: 'NONE', caption: '删除', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'Remove', target: 'MULTIKEY' } },

        deuiaction7: { name: 'deuiaction7', actiontarget: 'NONE', caption: '过滤', disabled: false, type: 'DEUIACTION', visabled: true,noprivdisplaymode:2,dataaccaction: '', uiaction: { tag: 'ToggleFilter', target: '' } },
   ...
   */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'jobs-info-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'JobsInfoGridView')){
                    return;
                }
    ...
    public toolbar_deuiaction1_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:JobsInfoUIService  = new JobsInfoUIService();
        curUIService.JobsInfo_Start(datas,contextJO, paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public toolbar_deuiaction2_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:JobsInfoUIService  = new JobsInfoUIService();
        curUIService.JobsInfo_Stop(datas,contextJO, paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public toolbar_deuiaction3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        const curUIService:JobsInfoUIService  = new JobsInfoUIService();
        curUIService.JobsInfo_Execute(datas,contextJO, paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public toolbar_deuiaction4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public toolbar_deuiaction5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Edit(datas, contextJO,paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public toolbar_deuiaction6_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Remove(datas, contextJO,paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public toolbar_deuiaction7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ToggleFilter(datas, contextJO,paramJO,  $event, xData,this,"JobsInfo");
    }
    ...
    public Edit(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        if (_this.opendata && _this.opendata instanceof Function) {
            const data: any = { };
            if (args.length > 0) {
                Object.assign(data, { jobsinfo: args[0].jobsinfo })
            }
...
<style lang='less'>
@import './jobs-info-grid-view.less';
</style>