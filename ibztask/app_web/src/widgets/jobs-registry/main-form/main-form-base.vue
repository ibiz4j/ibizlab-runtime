<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='jobsregistry_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "app";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.jobsregistry});
        }
        if (this.viewState) {
