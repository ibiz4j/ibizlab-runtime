...
module.exports = {
    ...
    outputDir:"../ibztask-app/ibztask-app-web/target/classes/META-INF/resources",
    devServer: {
        host: '0.0.0.0',
        port: 8111,
        compress: true,
    ...
    pages: {
        taskindexview: {
            // page 的入口
            entry: 'src/pages/task/task-index-view/main.ts',
            // 模板来源
    ...
    chainWebpack: (config) => {
        // 删除自动计算预加载资源
        config.plugins.delete('preload-taskindexview')
        // 删除预加载资源
        config.plugins.delete('prefetch-taskindexview')
