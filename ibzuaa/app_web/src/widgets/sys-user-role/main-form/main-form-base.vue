...
<app-picker 
  ...
  editortype="" 
  :pickupView="{ viewname: 'sys-userpickup-view', title: $t('entities.sysuser.views.pickupview.title'), deResParameters: [], parameters: [{ pathName: 'sysusers', parameterName: 'sysuser' }, { pathName: 'pickupview', parameterName: 'pickupview' } ], placement:'' }"
  style=""  
  @formitemvaluechange="onFormItemValueChange">
</app-picker>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        srfkey: [
            ...
            { required: this.detailsModel.srfkey.required, type: 'string', message: '用户角色关系标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.srfkey.required, type: 'string', message: '用户角色关系标识 值不能为空', trigger: 'blur' },
        ],
        srfmajortext: [
            { type: 'string', message: '用户标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.srfmajortext.required, type: 'string', message: '用户标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.srfmajortext.required, type: 'string', message: '用户标识 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        sys_roleid: [
            ...
            { required: this.detailsModel.sys_roleid.required, type: 'string', message: '角色标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.sys_roleid.required, type: 'string', message: '角色标识 值不能为空', trigger: 'blur' },
        ],
        sys_user_roleid: [
            { type: 'string', message: '用户角色关系标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户角色关系标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.sys_user_roleid.required, type: 'string', message: '用户角色关系标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.sys_user_roleid.required, type: 'string', message: '用户角色关系标识 值不能为空', trigger: 'blur' },
        ],
        sys_rolename: [
        ...
        sys_username: [
            ...
            { required: this.detailsModel.sys_username.required, type: 'string', message: '用户名称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.sys_username.required, type: 'string', message: '用户名称 值不能为空', trigger: 'blur' },
        ],
        sys_userid: [
            { type: 'string', message: '用户标识 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户标识 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.sys_userid.required, type: 'string', message: '用户标识 值不能为空', trigger: 'change' },
            { required: this.detailsModel.sys_userid.required, type: 'string', message: '用户标识 值不能为空', trigger: 'blur' },
        ],
        }
    }
...
, 
        srfkey: new FormItemModel({ caption: '用户角色关系标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '用户标识', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        sys_roleid: new FormItemModel({ caption: '角色标识', detailType: 'FORMITEM', name: 'sys_roleid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        sys_user_roleid: new FormItemModel({ caption: '用户角色关系标识', detailType: 'FORMITEM', name: 'sys_user_roleid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        sys_username: new FormItemModel({ caption: '用户名称', detailType: 'FORMITEM', name: 'sys_username', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        sys_userid: new FormItemModel({ caption: '用户标识', detailType: 'FORMITEM', name: 'sys_userid', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
    };
