<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysuserrole_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public formKeyItemName: string = 'sys_user_roleid';
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.sysuserrole});
        }
        if (this.viewState) {
