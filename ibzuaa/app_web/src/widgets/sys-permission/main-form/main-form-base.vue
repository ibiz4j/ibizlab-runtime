<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='syspermission_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "sys_permissionname";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.syspermission});
        }
        if (this.viewState) {
