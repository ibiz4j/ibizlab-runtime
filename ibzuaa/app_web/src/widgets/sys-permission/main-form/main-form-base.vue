...
, 
        srfkey: new FormItemModel({ caption: '资源标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '资源名称', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        sys_permissionname: new FormItemModel({ caption: '资源名称', detailType: 'FORMITEM', name: 'sys_permissionname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        sys_permissionid: new FormItemModel({ caption: '资源标识', detailType: 'FORMITEM', name: 'sys_permissionid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
