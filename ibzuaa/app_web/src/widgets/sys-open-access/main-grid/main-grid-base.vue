  ...
  <i-form style="height:100%;display:flex;flex-direction: column;justify-content: space-between">
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            ...
            <template v-if="getColumnState('accessid')">
                <el-table-column show-overflow-tooltip :prop="'accessid'" :label="$t('entities.sysopenaccess.main_grid.columns.accessid')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.accessid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.accessid}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('open_type')">
                <el-table-column show-overflow-tooltip :prop="'open_type'" :label="$t('entities.sysopenaccess.main_grid.columns.open_type')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.open_type')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('accessname')">
                <el-table-column show-overflow-tooltip :prop="'accessname'" :label="$t('entities.sysopenaccess.main_grid.columns.accessname')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.accessname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('access_key')">
                <el-table-column show-overflow-tooltip :prop="'access_key'" :label="$t('entities.sysopenaccess.main_grid.columns.access_key')" :width="300"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.access_key')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.access_key}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('disabled')">
                <el-table-column show-overflow-tooltip :prop="'disabled'" :label="$t('entities.sysopenaccess.main_grid.columns.disabled')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.disabled')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <template >
            ...
            <template v-if="getColumnState('region_id')">
                <el-table-column show-overflow-tooltip :prop="'region_id'" :label="$t('entities.sysopenaccess.main_grid.columns.region_id')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.region_id')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('redirect_uri')">
                <el-table-column show-overflow-tooltip :prop="'redirect_uri'" :label="$t('entities.sysopenaccess.main_grid.columns.redirect_uri')" :width="500"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.sysopenaccess.main_grid.columns.redirect_uri')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    */
    ...
    public allColumns: any[] = [
        {
            name: 'accessid',
            label: '开放平台接入标识',
            langtag: 'entities.sysopenaccess.main_grid.columns.accessid',
            show: true,
            unit: 'PX',
        ...
        },
        {
            name: 'open_type',
            label: '开放平台类型',
            langtag: 'entities.sysopenaccess.main_grid.columns.open_type',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'accessname',
            label: '开放平台',
            langtag: 'entities.sysopenaccess.main_grid.columns.accessname',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            ...
            langtag: 'entities.sysopenaccess.main_grid.columns.access_key',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'disabled',
            label: '是否禁用',
            langtag: 'entities.sysopenaccess.main_grid.columns.disabled',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'region_id',
            label: 'RegionId',
            langtag: 'entities.sysopenaccess.main_grid.columns.region_id',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
        },
        {
            name: 'redirect_uri',
            label: 'RedirectURI',
            langtag: 'entities.sysopenaccess.main_grid.columns.redirect_uri',
            show: true,
            unit: 'PX',
            isEnableRowEdit: false,
            enableCond: 3 ,
    ...
    public rules(){
        return {
            srfkey: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysopenaccess.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.sysopenaccess.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
        }
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOpenAccessGridView'+(this.$t('app.gridpage.notConfig.fetchAction') as string) });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOpenAccessGridView'+(this.$t('app.gridpage.notConfig.removeAction') as string) });
            return;
        }
        let _datas:any[] = [];
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ sysopenaccess: _keys }),Object.assign({ sysopenaccess: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
        ...
        const doExport = async (_data:any) => {
            ...
            this.$export.exportExcel().then((excel:any)=>{
                excel.export_json_to_excel({
                  ...
                  data, //具体数据 必填
                  filename: "第三方认证平台"+(this.$t('app.gridpage.grid') as string), //非必填
                  autoWidth: true, //非必填
                  bookType: "xlsx" //非必填
                });
            }); 
    ...
    public afterCreated(){
        ...
        if(AppCenterService && AppCenterService.getMessageCenter()){
            this.appStateEvent = AppCenterService.getMessageCenter().subscribe(({ name, action, data }) =>{
                if(!Object.is(name,"SysOpenAccess")){
                    return;
                }
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['accessid','open_type','accessname','access_key','disabled','region_id','redirect_uri'];
        if(row && row.children) {
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.sysopenaccess,$event.sysopenaccess);
        });
    ...
    public setColState() {
        ...
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzuaa_web_sysopenaccessgridview_grid_main'});
    ...
    public getColStorage() {
        const _data: any = localStorage.getItem('sys_open_access_main_grid');
        if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('sys_open_access_main_grid', JSON.stringify(this.allColumns));
    }
    ...
    public saveDynaConfig() {
        const viewParams: any = Util.deepCopy(this.viewparams);
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzuaa_web_sysopenaccessgridview_grid_main', model: this.allColumns});
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOpenAccessGridView'+(this.$t('app.gridpage.notConfig.createAction') as string) });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOpenAccessGridView'+(this.$t('app.gridpage.notConfig.updateAction') as string) });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.sysopenaccess){
                            Object.assign(this.context,{sysopenaccess:item.sysopenaccess});
                        }
            ...
            errorItems.forEach((item: any, index: number) => {
                if(errorMessage[index] && errorMessage[index].data) {
                    if(Object.is(errorMessage[index].data.errorKey, 'DupCheck')) {
                        ...
                        let name: string = this.service.getNameByProp("accessid");
                        if(name){
                            let desc: any = this.allColumns.find((column: any) =>{
                                return Object.is(column.name, name);
                            });
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'SysOpenAccessGridView'+(this.$t('app.gridpage.notConfig.loaddraftAction') as string) });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.sysopenaccess,args.row.sysopenaccess);
        });
