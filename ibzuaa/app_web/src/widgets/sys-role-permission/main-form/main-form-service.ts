...
export default class MainService extends ControlService {
     ...
     */
    public appEntityService: SysRolePermissionService = new SysRolePermissionService({ $store: this.getStore() });
     ...
     * @memberof MainService
     */
    public syspermissionService: SysPermissionService = new SysPermissionService();
    ...
    public getItems(serviceName: string, interfaceName: string, context: any = {}, data: any, isloading?: boolean): Promise<any[]> {
        if (Object.is(serviceName, 'SysRoleService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.sysroleService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'roleid', 'sysrole');
        }
        if (Object.is(serviceName, 'SysPermissionService') && Object.is(interfaceName, 'FetchDefault')) {
            return this.doItems(this.syspermissionService.FetchDefault(JSON.parse(JSON.stringify(context)),data, isloading), 'permissionid', 'syspermission');
        }
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.sysrolepermission = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
