<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysrolepermission_main' style="" @on-validate="formItemValidate">
...
import SysRolePermissionEntityService from '@/service/sys-role-permission/sys-role-permission-service';
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: SysRolePermissionEntityService = new SysRolePermissionEntityService({ $store: this.$store });
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.sysrolepermission});
        }
        if (this.viewState) {
