...
<i-col v-show="detailsModel.group1.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
    <app-form-group layoutType="TABLE_24COL" titleStyle="" class='' :uiActionGroup="detailsModel.group1.uiActionGroup" @groupuiactionclick="groupUIActionClick($event)" :caption="$t('entities.sysrolepermission.main_form.details.group1')" :isShowCaption="true" uiStyle="DEFAULT" :titleBarCloseMode="0" :isInfoGroupMode="false" >    
    <row>
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    public detailsModel: any = {
        group1: new FormGroupPanelModel({ caption: '角色权限关系表基本信息', detailType: 'GROUPPANEL', name: 'group1', visible: true, isShowCaption: true, form: this, uiActionGroup: { caption: '', langbase: 'entities.sysrolepermission.main_form', extractMode: 'ITEM', details: [] } })
, 
...
, 
        srfkey: new FormItemModel({ caption: '角色权限关系表标识', detailType: 'FORMITEM', name: 'srfkey', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        srfmajortext: new FormItemModel({ caption: '权限表标识', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        sys_permissionname: new FormItemModel({ caption: '权限名称', detailType: 'FORMITEM', name: 'sys_permissionname', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
        sys_permissionid: new FormItemModel({ caption: '权限表标识', detailType: 'FORMITEM', name: 'sys_permissionid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
...
, 
        sys_role_permissionid: new FormItemModel({ caption: '角色权限关系表标识', detailType: 'FORMITEM', name: 'sys_role_permissionid', visible: true, isShowCaption: true, form: this, disabled: false, enableCond: 3 })
, 
    };
