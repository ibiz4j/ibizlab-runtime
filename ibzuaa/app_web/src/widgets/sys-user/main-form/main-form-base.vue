<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysuser_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public formKeyItemName: string = 'userid';
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.sysuser});
        }
        if (this.viewState) {
