<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='sysuser_main' style="">
...
export default class MainBase extends Vue implements ControlInterface {
    ...
    return {
        ...
        srfmajortext: [
            { type: 'string', message: '用户姓名 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户姓名 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.srfmajortext.required, type: 'string', message: '用户姓名 值不能为空', trigger: 'change' },
            { required: this.detailsModel.srfmajortext.required, type: 'string', message: '用户姓名 值不能为空', trigger: 'blur' },
        ],
        srftempmode: [
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: ' 值必须为字符串类型', trigger: 'blur' },
        ...
        personname: [
            { type: 'string', message: '用户姓名 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '用户姓名 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.personname.required, type: 'string', message: '用户姓名 值不能为空', trigger: 'change' },
            { required: this.detailsModel.personname.required, type: 'string', message: '用户姓名 值不能为空', trigger: 'blur' },
        ],
        loginname: [
        ...
        orgname: [
            ...
            { required: this.detailsModel.orgname.required, type: 'string', message: '单位名称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.orgname.required, type: 'string', message: '单位名称 值不能为空', trigger: 'blur' },
        ],
        mdeptname: [
            { type: 'string', message: '主部门名称 值必须为字符串类型', trigger: 'change' },
            { type: 'string', message: '主部门名称 值必须为字符串类型', trigger: 'blur' },
            { required: this.detailsModel.mdeptname.required, type: 'string', message: '主部门名称 值不能为空', trigger: 'change' },
            { required: this.detailsModel.mdeptname.required, type: 'string', message: '主部门名称 值不能为空', trigger: 'blur' },
        ],
        }
    }
...
, 
        srfmajortext: new FormItemModel({ caption: '用户姓名', detailType: 'FORMITEM', name: 'srfmajortext', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        personname: new FormItemModel({ caption: '用户姓名', detailType: 'FORMITEM', name: 'personname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
...
, 
        orgname: new FormItemModel({ caption: '单位名称', detailType: 'FORMITEM', name: 'orgname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
        mdeptname: new FormItemModel({ caption: '主部门名称', detailType: 'FORMITEM', name: 'mdeptname', visible: true, isShowCaption: true, form: this, isControlledContent: false , required:false, disabled: false, enableCond: 3 })
, 
    };
    ...
    public print(){
        let _this:any = this;
        _this.$print({id:'sysuser_main',popTitle:'主编辑表单'});
    }
    ...
    public autoSave(opt: any = {}): void {
        ...
        post.then((response: any) => {
            ...
            this.$emit('save', data);
            AppCenterService.notifyMessage({name:"SysUser",action:'appRefresh',data:data});
            this.$nextTick(() => {
    ...
    */
    ...
    public async wfsubmit(data: any,localdata?:any): Promise<any> {
        ...
        Object.assign(arg,{viewparams:this.viewparams});
        if (!arg.sysuser || Object.is(arg.sysuser, '')) {
            return;
        }
