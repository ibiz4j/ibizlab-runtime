<template>
<div class="view-container deeditview2 sys-useredit-view2">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sys_usereditview2"></app-studioaction>
    ...
    <template v-if="Object.is(this.selection.id, 'form')">
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem3.visabled" :disabled="toolBarModels.tbitem3.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem3' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem3.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem3.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem5.visabled" :disabled="toolBarModels.tbitem5.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem5' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem5.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem5.tip')}}</div>
        </tooltip>
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem12.visabled" :disabled="toolBarModels.tbitem12.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem12' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem12.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem12.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem14.visabled" :disabled="toolBarModels.tbitem14.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem14' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem14.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.sysuser.editview2toolbar_toolbar.tbitem14.tip')}}</div>
        </tooltip>
    </div>
      </template>
</div>
...
export default class SYS_USEREditView2Base extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysuser.views.editview2.caption',
        srfTitle: 'entities.sysuser.views.editview2.title',
        srfSubTitle: 'entities.sysuser.views.editview2.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-useredit-view2',tag:this.viewtag,srfkey:isNew ? null : this.context.sysuser,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-useredit-view2',tag:this.viewtag,srfkey:this.context.sysuser,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-useredit-view2')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SYS_USEREditView2')){
                    return;
                }
...
<style lang='less'>
@import './sys-useredit-view2.less';
</style>