<template>
<div class="view-container deeditview2 sys-role-permissionedit-view2">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sys_role_permissioneditview2"></app-studioaction>
...
export default class SYS_ROLE_PERMISSIONEditView2Base extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysrolepermission.views.editview2.caption',
        srfTitle: 'entities.sysrolepermission.views.editview2.title',
        srfSubTitle: 'entities.sysrolepermission.views.editview2.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-role-permissionedit-view2',tag:this.viewtag,srfkey:isNew ? null : this.context.sysrolepermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-role-permissionedit-view2',tag:this.viewtag,srfkey:this.context.sysrolepermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SYS_ROLE_PERMISSIONEditView2')){
                    return;
                }
...
<style lang='less'>
@import './sys-role-permissionedit-view2.less';
</style>