<template>
<div class="view-container deeditview sys-permissionedit-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sys_permissioneditview"></app-studioaction>
...
export default class SYS_PERMISSIONEditViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.syspermission.views.editview.caption',
        srfTitle: 'entities.syspermission.views.editview.title',
        srfSubTitle: 'entities.syspermission.views.editview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-permissionedit-view',tag:this.viewtag,srfkey:isNew ? null : this.context.syspermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-permissionedit-view',tag:this.viewtag,srfkey:this.context.syspermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SYS_PERMISSIONEditView')){
                    return;
                }
...
<style lang='less'>
@import './sys-permissionedit-view.less';
</style>