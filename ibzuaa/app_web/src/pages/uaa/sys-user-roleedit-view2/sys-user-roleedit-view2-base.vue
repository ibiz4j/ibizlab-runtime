<template>
<div class="view-container deeditview2 sys-user-roleedit-view2">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="sys_user_roleeditview2"></app-studioaction>
...
<div slot='title' class="header-container">
    ...
    <template v-if="Object.is(this.selection.id, 'form')">
        ...
        <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.sysuserrole.editview2toolbar_toolbar.tbitem5.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.sysuserrole.editview2toolbar_toolbar.tbitem12.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>    <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.sysuserrole.editview2toolbar_toolbar.tbitem14.tip')}}</div>
        </tooltip>
    </div>
      </template>
</div>
...
export default class SYS_USER_ROLEEditView2Base extends Vue {
	 ...
	 * @memberof SYS_USER_ROLEEditView2Base
	 */
	public viewtag: string = 'ede089b4741590173bd21b9df99c1cf0';
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysuserrole.views.editview2.caption',
        srfTitle: 'entities.sysuserrole.views.editview2.title',
        srfSubTitle: 'entities.sysuserrole.views.editview2.subtitle',
        dataInfo: ''
    }
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-user-roleedit-view2',tag:this.viewtag,srfkey:isNew ? null : this.context.sysuserrole,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-user-roleedit-view2',tag:this.viewtag,srfkey:this.context.sysuserrole,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-user-roleedit-view2')){
                return;
            }
...
<style lang='less'>
@import './sys-user-roleedit-view2.less';
</style>