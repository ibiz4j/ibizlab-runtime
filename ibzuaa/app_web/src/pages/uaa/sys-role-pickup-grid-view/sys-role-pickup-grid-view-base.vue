<template>
<div class='view-container depickupgridview sys-role-pickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sysrolepickupgridview"></app-studioaction>
...
export default class SysRolePickupGridViewBase extends Vue {
	 ...
	 * @memberof SysRolePickupGridViewBase
	 */
	public viewtag: string = '7c25865f5864a734477c7cb987632f4f';
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-role-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysrole,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-role-pickup-grid-view',tag:this.viewtag,srfkey:this.context.sysrole,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-role-pickup-grid-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysRolePickupGridView')){
                    return;
                }
...
<style lang='less'>
@import './sys-role-pickup-grid-view.less';
</style>