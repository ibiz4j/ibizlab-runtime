...
export default class SysUserRoleEditView2Base extends Vue {
	 ...
	 * @memberof SysUserRoleEditView2Base
	 */
	public viewtag: string = '5f3c84ff2431eb5d992a129e3a191305';
    ...
    */
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-user-role-edit-view2')){
                return;
            }
...
<style lang='less'>
@import './sys-user-role-edit-view2.less';
</style>