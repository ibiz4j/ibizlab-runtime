<template>
<div class="view-container depickupview sys-role-permission-pickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sysrolepermissionpickupview"></app-studioaction>
...
export default class SysRolePermissionPickupViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysrolepermission.views.pickupview.caption',
        srfTitle: 'entities.sysrolepermission.views.pickupview.title',
        srfSubTitle: 'entities.sysrolepermission.views.pickupview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-role-permission-pickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysrolepermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-role-permission-pickup-view',tag:this.viewtag,srfkey:this.context.sysrolepermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-role-permission-pickup-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SysRolePermissionPickupView')){
                    return;
                }
...
<style lang='less'>
@import './sys-role-permission-pickup-view.less';
</style>