<template>
<div class='view-container depickupgridview sys-permissionpickup-grid-view'>
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sys_permissionpickupgridview"></app-studioaction>
...
export default class SYS_PERMISSIONPickupGridViewBase extends Vue {
	 ...
	 * @memberof SYS_PERMISSIONPickupGridViewBase
	 */
	public viewtag: string = '9c0b351150648f7661be53c10eaabd67';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-permissionpickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.syspermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-permissionpickup-grid-view',tag:this.viewtag,srfkey:this.context.syspermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
...
<style lang='less'>
@import './sys-permissionpickup-grid-view.less';
</style>