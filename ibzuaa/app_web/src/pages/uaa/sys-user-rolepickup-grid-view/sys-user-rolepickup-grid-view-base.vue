...
export default class SYS_USER_ROLEPickupGridViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysuserrole.views.pickupgridview.caption',
        srfTitle: 'entities.sysuserrole.views.pickupgridview.title',
        srfSubTitle: 'entities.sysuserrole.views.pickupgridview.subtitle',
        dataInfo: ''
    }
    ...
    */
    ...
    public initNavData(data:any = null){
        if(this.viewDefaultUsage){
            this.navDataService.addNavData({id:'sys-user-rolepickup-grid-view',srfkey:this.context.sysuserrole,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-user-rolepickup-grid-view')){
                return;
            }
...
<style lang='less'>
@import './sys-user-rolepickup-grid-view.less';
</style>