<template>
<div class="view-container dempickupview sys-user-rolempickup-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sys_user_rolempickupview"></app-studioaction>
...
export default class SYS_USER_ROLEMPickupViewBase extends Vue {
	 ...
	 * @memberof SYS_USER_ROLEMPickupViewBase
	 */
	public viewtag: string = 'f9ea95b9d193ee076ea0d826270f8753';
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysuserrole.views.mpickupview.caption',
        srfTitle: 'entities.sysuserrole.views.mpickupview.title',
        srfSubTitle: 'entities.sysuserrole.views.mpickupview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-user-rolempickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysuserrole,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-user-rolempickup-view',tag:this.viewtag,srfkey:this.context.sysuserrole,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'sys-user-rolempickup-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SYS_USER_ROLEMPickupView')){
                    return;
                }
...
<style lang='less'>
@import './sys-user-rolempickup-view.less';
</style>