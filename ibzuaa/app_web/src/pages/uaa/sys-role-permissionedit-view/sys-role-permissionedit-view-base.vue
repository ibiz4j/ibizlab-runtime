<template>
<div class="view-container deeditview sys-role-permissionedit-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="sys_role_permissioneditview"></app-studioaction>
...
export default class SYS_ROLE_PERMISSIONEditViewBase extends Vue {
	 ...
	 * @memberof SYS_ROLE_PERMISSIONEditViewBase
	 */
	public viewtag: string = 'a93a129850b81c3c921aa1911ec9eb8c';
     ...
     */
    public model: any = {
        srfCaption: 'entities.sysrolepermission.views.editview.caption',
        srfTitle: 'entities.sysrolepermission.views.editview.title',
        srfSubTitle: 'entities.sysrolepermission.views.editview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-role-permissionedit-view',tag:this.viewtag,srfkey:isNew ? null : this.context.sysrolepermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-role-permissionedit-view',tag:this.viewtag,srfkey:this.context.sysrolepermission,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'SYS_ROLE_PERMISSIONEditView')){
                    return;
                }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"SysRolePermission");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"SysRolePermission");
    }
    ...
    public toolbar_tbitem9_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndStart(datas, contextJO,paramJO,  $event, xData,this,"SysRolePermission");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"SysRolePermission");
    }
...
<style lang='less'>
@import './sys-role-permissionedit-view.less';
</style>