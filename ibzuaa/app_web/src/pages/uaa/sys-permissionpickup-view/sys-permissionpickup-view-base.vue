...
<div class="view-container depickupview sys-permissionpickup-view">
    <app-studioaction :viewTitle="$t(model.srfTitle)" viewName="sys_permissionpickupview"></app-studioaction>
...
export default class SYS_PERMISSIONPickupViewBase extends Vue {
	 ...
	 * @memberof SYS_PERMISSIONPickupViewBase
	 */
	public viewtag: string = '8fa92a05b6911e82d9b20fd5aa37a838';
    ...
    */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'sys-permissionpickup-view',tag:this.viewtag,srfkey:isNew ? null : this.context.syspermission,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'sys-permissionpickup-view',tag:this.viewtag,srfkey:this.context.syspermission,title:this.$t(this.model.srfTitle),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
