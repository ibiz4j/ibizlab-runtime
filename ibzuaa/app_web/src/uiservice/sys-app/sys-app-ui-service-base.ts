...
export default class SysAppUIServiceBase extends UIService {
    ...
    constructor(opts: any = {}) {
        super(opts);
        this.authService = new SysAppAuthService(opts);
        this.initViewMap();
     ...
     */  
    public initViewMap(){
        this.allViewMap.set('MDATAVIEW:',{viewname:'gridview',srfappde:'sysapps',component:'sys-app-grid-view'});
        this.allViewMap.set('EDITVIEW:',{viewname:'editview',srfappde:'sysapps',component:'sys-app-edit-view'});
    }
