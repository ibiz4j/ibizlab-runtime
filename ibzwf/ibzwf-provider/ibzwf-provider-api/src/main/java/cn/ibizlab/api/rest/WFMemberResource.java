...
public class WFMemberResource {
    ...
    @PreAuthorize("hasPermission(this.wfmemberMapping.toDomain(#wfmemberdtos),'ibzwf-WFMember-Create')")
    ...
    @PreAuthorize("hasPermission(this.wfmemberService.get(#wfmember_id),'ibzwf-WFMember-Update')")
    ...
    @PreAuthorize("hasPermission(this.wfmemberService.getWfmemberByEntities(this.wfmemberMapping.toDomain(#wfmemberdtos)),'ibzwf-WFMember-Update')")
    ...
    @PreAuthorize("hasPermission(this.wfmemberService.get(#wfmember_id),'ibzwf-WFMember-Remove')")
    ...
    @PreAuthorize("hasPermission(this.wfmemberService.getWfmemberByIds(#ids),'ibzwf-WFMember-Remove')")
    ...
    @PostAuthorize("hasPermission(this.wfmemberMapping.toDomain(returnObject.body),'ibzwf-WFMember-Get')")
