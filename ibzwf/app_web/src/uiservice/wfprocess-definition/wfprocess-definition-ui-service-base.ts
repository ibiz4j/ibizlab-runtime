 ...
 *
 * @export
 * @class WFProcessDefinitionUIServiceBase
 */
export default class WFProcessDefinitionUIServiceBase extends UIService {
     ...
     * @memberof  WFProcessDefinitionUIServiceBase
     */
    public dataService:WFProcessDefinitionService = new WFProcessDefinitionService();
    ...
    /**
     * Creates an instance of  WFProcessDefinitionUIServiceBase.
     * 
     * @param {*} [opts={}]
     * @memberof  WFProcessDefinitionUIServiceBase
     */
    ...
    public async getRDAppView(srfkey:string,isEnableWorkflow:boolean){
        ...
        // 进行数据查询
        let result:any = await this.dataService.Get({wfprocessdefinition:srfkey});
