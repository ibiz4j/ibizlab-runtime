...
import JumpModel from './jump-form-model';
 ...
 * @class JumpService
 */
export default class JumpService extends ControlService {

    /**
     * 流程实例服务对象
     *
     * @type {WFProcessInstanceService}
     * @memberof JumpService
     */
    public appEntityService: WFProcessInstanceService = new WFProcessInstanceService({ $store: this.getStore() });
    ...
    /**
     * Creates an instance of JumpService.
     * 
     * @param {*} [opts={}]
     * @memberof JumpService
     */
    ...
    public loadDraft(action: string,context: any = {}, data: any = {}, isloading?: boolean): Promise<any> {
        ...
        Data.id = PrimaryKey;
        Data.wfprocessinstance = PrimaryKey;
        return new Promise((resolve: any, reject: any) => {
            let result: Promise<any>;
            const _appEntityService: any = this.appEntityService;
            if (_appEntityService[action] && _appEntityService[action] instanceof Function) {
