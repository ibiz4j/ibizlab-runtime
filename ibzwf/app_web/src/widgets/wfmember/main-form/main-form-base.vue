<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='wfmember_main' style="" @on-validate="formItemValidate">
...
import WFMemberEntityService from '@/service/wfmember/wfmember-service';
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public appEntityService: WFMemberEntityService = new WFMemberEntityService({ $store: this.$store });
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.wfmember});
        }
        if (this.viewState) {
