  ...
  <i-form style="height:100%;display:flex;flex-direction: column;justify-content: space-between">
    <el-table v-if="isDisplay === true"
        ...
        ref='multipleTable' :data="items" :show-header="!isHideHeader">
            <template slot="empty">
                {{$t('entities.wftask.main_grid.nodata')}} 
            </template>
            <template v-if="!isSingleSelect">
                <el-table-column align="center" type='selection' :width="checkboxColWidth"></el-table-column>
            </template>
            <template v-if="getColumnState('definitionname')">
                <el-table-column show-overflow-tooltip :prop="'definitionname'" :label="$t('entities.wftask.main_grid.columns.definitionname')" :width="250"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.definitionname')}}
                      </span>
                    </template>
            ...
            <template v-if="getColumnState('taskname')">
                <el-table-column show-overflow-tooltip :prop="'taskname'" :label="$t('entities.wftask.main_grid.columns.taskname')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.taskname')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('description')">
                <el-table-column show-overflow-tooltip :prop="'description'" :label="$t('entities.wftask.main_grid.columns.description')" :width="350"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.description')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('createtime')">
                <el-table-column show-overflow-tooltip :prop="'createtime'" :label="$t('entities.wftask.main_grid.columns.createtime')" :width="200"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.createtime')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <app-format-data format="YYYY-MM-DD HH:mm:ss" :data="row.createtime"></app-format-data>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('businesskey')">
                <el-table-column show-overflow-tooltip :prop="'businesskey'" :label="$t('entities.wftask.main_grid.columns.businesskey')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.businesskey')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('definitionid')">
                <el-table-column show-overflow-tooltip :prop="'definitionid'" :label="$t('entities.wftask.main_grid.columns.definitionid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.definitionid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.definitionid}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('definitionkey')">
                <el-table-column show-overflow-tooltip :prop="'definitionkey'" :label="$t('entities.wftask.main_grid.columns.definitionkey')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.definitionkey')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('instanceid')">
                <el-table-column show-overflow-tooltip :prop="'instanceid'" :label="$t('entities.wftask.main_grid.columns.instanceid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.instanceid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
            ...
            <template v-if="getColumnState('taskdefinitionkey')">
                <el-table-column show-overflow-tooltip :prop="'taskdefinitionkey'" :label="$t('entities.wftask.main_grid.columns.taskdefinitionkey')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.taskdefinitionkey')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
                        <span>{{row.taskdefinitionkey}}</span>
                    </template>
                </el-table-column>
            </template>
            <template v-if="getColumnState('taskid')">
                <el-table-column show-overflow-tooltip :prop="'taskid'" :label="$t('entities.wftask.main_grid.columns.taskid')" :width="100"  :align="'left'" :sortable="'custom'">
                    <template v-slot:header="{column}">
                      <span class="column-header ">
                        {{$t('entities.wftask.main_grid.columns.taskid')}}
                      </span>
                    </template>
                    <template v-slot="{row,column,$index}">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * 界面UI服务对象
     *
     * @type {WFTaskUIService}
     * @memberof MainBase
     */  
    public appUIService:WFTaskUIService = new WFTaskUIService(this.$store);
    ...
    */
     ...
     * @memberof MainBase
     */
    public minorSortPSDEF: string = 'createtime';
    ...
    */
    ...
    public rules(){
        return {
            srfkey: [
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.wftask.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'change' },
                { required: false, validator: (rule:any, value:any, callback:any) => { return (rule.required && (value === null || value === undefined || value === "")) ? false : true;}, message: `${this.$t('entities.wftask.main_grid.columns.srfkey')}${this.$t('app.commonWords.valueNotEmpty')}`, trigger: 'blur' },
            ],
        }
    }
    ...
    public load(opt: any = {}, pageReset: boolean = false): void {
        if(!this.fetchAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'WFTaskGridView'+(this.$t('app.gridpage.notConfig.fetchAction') as string) });
            return;
        }
        if(pageReset){
            this.curPage = 1;
    ...
    public async remove(datas: any[]): Promise<any> {
        if(!this.removeAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'WFTaskGridView'+(this.$t('app.gridpage.notConfig.removeAction') as string) });
            return;
        }
        let _datas:any[] = [];
        ...
        _datas.forEach((record: any, index: number) => {
            let srfmajortext = record.taskname;
            if (index < 5) {
        ...
        const removeData = () => {
            ...
            const post: Promise<any> = this.service.delete(_removeAction,Object.assign(context,{ wftask: _keys }),Object.assign({ wftask: _keys },{viewparams:this.viewparams}), this.showBusyIndicator);
        ...
        const doExport = async (_data:any) => {
            ...
            this.$export.exportExcel().then((excel:any)=>{
                excel.export_json_to_excel({
                  ...
                  data, //具体数据 必填
                  filename: "工作流任务"+(this.$t('app.gridpage.grid') as string), //非必填
                  autoWidth: true, //非必填
                  bookType: "xlsx" //非必填
                });
            }); 
    ...
    */
    public arraySpanMethod({row, column, rowIndex, columnIndex} : any) {
        let allColumns:Array<any> = ['definitionname','taskname','description','createtime','businesskey','definitionid','definitionkey','instanceid','taskdefinitionkey','taskid'];
        if(row && row.children) {
    ...
    public rowClick($event: any, ifAlways: boolean = false): void {
        ...
        let selectIndex = this.selections.findIndex((item:any)=>{
            return Object.is(item.wftask,$event.wftask);
        });
    ...
    public setColState() {
        ...
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzwf_web_wftaskgridview_grid_main'});
    ...
    public getColStorage() {
        const _data: any = localStorage.getItem('wf_task_main_grid');
        if (_data) {
     ...
     */
    public onColChange() {
        localStorage.setItem('wf_task_main_grid', JSON.stringify(this.allColumns));
    }
    ...
    public saveDynaConfig() {
        const viewParams: any = Util.deepCopy(this.viewparams);
        Object.assign(viewParams,{utilServiceName: 'grid_dynaconfig', modelid: 'ibzwf_web_wftaskgridview_grid_main', model: this.allColumns});
            ...
            try {
                if(Object.is(item.rowDataState, 'create')){
                    if(!this.createAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'WFTaskGridView'+(this.$t('app.gridpage.notConfig.createAction') as string) });
                    }else{
                    ...
                    if(!this.updateAction){
                        this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'WFTaskGridView'+(this.$t('app.gridpage.notConfig.updateAction') as string) });
                    }else{
                        Object.assign(item,{viewparams:this.viewparams});
                        if(item.wftask){
                            Object.assign(this.context,{wftask:item.wftask});
                        }
    ...
    public newRow(args: any[], params?: any, $event?: any, xData?: any): void {
        if(!this.loaddraftAction){
            this.$Notice.error({ title: (this.$t('app.commonWords.wrong') as string), desc: 'WFTaskGridView'+(this.$t('app.gridpage.notConfig.loaddraftAction') as string) });
            return;
        }
        let _this = this;
    ...
    public getRowClassName(args:{row: any,rowIndex: number}){
        let isSelected = this.selections.some((item:any)=>{
            return Object.is(item.wftask,args.row.wftask);
        });
