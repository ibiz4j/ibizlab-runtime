<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='wfprocessdefinition_main' style="" @on-validate="formItemValidate">
...
<i-col v-show="detailsModel.bpmnfile.visible" :style="{}"  :lg="{ span: 24, offset: 0 }">
  ...
  name='bpmnfile'
  :value="data.bpmnfile"
  :disabled="detailsModel.bpmnfile.disabled"
  :uploadparams='{}'
  :exportparams='{}'
  :multiple='true'
  style="overflow: auto;">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "definitionname";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.wfprocessdefinition});
        }
        if (this.viewState) {
