...
export default class WFUserEditViewBase extends Vue {
	 ...
	 * @memberof WFUserEditViewBase
	 */
	public viewtag: string = 'ffd6ce24e0a1aa780920b48721e502a7';
   ...
   */
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'WFUserEditView')){
                    return;
                }
    ...
    public FirstRecord(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        let allNavData:any = Object.is(this.navModel,"route")?navDataService.getPreNavDataById('wfuser-edit-view'):navDataService.getPreNavDataByTag(_this.viewtag);
