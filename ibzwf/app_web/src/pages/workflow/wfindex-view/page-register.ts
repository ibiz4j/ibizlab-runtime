export const PageComponents = {
    install(Vue: any, opt: any) {
        ...
        Vue.component('wfprocess-instance-active-instance-grid-view', () => import('@pages/workflow/wfprocess-instance-active-instance-grid-view/wfprocess-instance-active-instance-grid-view.vue'));
        ...
        Vue.component('wfprocess-node-porcess-node-pickup-view', () => import('@pages/workflow/wfprocess-node-porcess-node-pickup-view/wfprocess-node-porcess-node-pickup-view.vue'));
        ...
        Vue.component('wfprocess-node-process-node-pickup-grid-view', () => import('@pages/workflow/wfprocess-node-process-node-pickup-grid-view/wfprocess-node-process-node-pickup-grid-view.vue'));
