<template>
<div class="index_view wfindex-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="wfindexview"></app-studioaction>
...
export default class WFIndexViewBase extends Vue {
   ...
   */
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'WFIndexView')){
                    return;
                }
    ...
    public afterMounted(){
        ...
        this.$viewTool.setIndexParameters([{ pathName: 'wfindexview', parameterName: 'wfindexview' }]);
