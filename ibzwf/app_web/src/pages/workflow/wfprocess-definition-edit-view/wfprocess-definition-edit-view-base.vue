...
export default class WFProcessDefinitionEditViewBase extends Vue {
   ...
   */
    ...
    public afterCreated(){
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'WFProcessDefinitionEditView')){
                    return;
                }
    ...
    public FirstRecord(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        let allNavData:any = Object.is(this.navModel,"route")?navDataService.getPreNavDataById('wfprocess-definition-edit-view'):navDataService.getPreNavDataByTag(_this.viewtag);
