...
module.exports = {
    ...
    outputDir:"../ibzwf-app/ibzwf-app-web/target/classes/META-INF/resources",
    devServer: {
        host: '0.0.0.0',
        port: 8111,
        compress: true,
    ...
    pages: {
        wfindexview: {
            // page 的入口
            entry: 'src/pages/workflow/wfindex-view/main.ts',
            // 模板来源
    ...
    chainWebpack: (config) => {
        // 删除自动计算预加载资源
        config.plugins.delete('preload-wfindexview')
        // 删除预加载资源
        config.plugins.delete('prefetch-wfindexview')
