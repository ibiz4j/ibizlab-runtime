...
module.exports = {
    ...
    outputDir:"../ibzpay-app/ibzpay-app-web/target/classes/META-INF/resources",
    devServer: {
        host: '0.0.0.0',
        port: 8111,
        compress: true,
        ...
        historyApiFallback: {
            rewrites: [
               // { from: /^\/payindexview$/, to: '/payindexview.html' },
            ]
        }
    },
    pages: {
        ...
        index : {
            // page 的入口
            entry: 'src/pages/pay/pay-index-view/main.ts',
            // 模板来源
    ...
    chainWebpack: (config) => {
        config.plugins.delete('preload-payindexview')
        config.plugins.delete('prefetch-payindexview')
