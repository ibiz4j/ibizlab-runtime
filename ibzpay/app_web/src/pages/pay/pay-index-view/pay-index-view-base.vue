<template>
<div class="index_view pay-index-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="payindexview"></app-studioaction>
                ...
                <header class="index_header">
                    <div class="header-left" >
                        <div class="page-logo">
                            ...
                            <app-breadcrumb  :navModel="navModel" indexViewTag="pay-index-view"></app-breadcrumb>
                        </div>
                    </div>
...
export default class PayIndexViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'app.views.payindexview.caption',
        srfTitle: 'app.views.payindexview.title',
        srfSubTitle: 'app.views.payindexview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'pay-index-view',tag:this.viewtag,srfkey:isNew ? null : null,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'pay-index-view',tag:this.viewtag,srfkey:null,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'pay-index-view')){
                return;
            }
    ...
    public afterMounted(){
        ...
        this.$viewTool.setIndexParameters([{ pathName: 'payindexview', parameterName: 'payindexview' }]);
