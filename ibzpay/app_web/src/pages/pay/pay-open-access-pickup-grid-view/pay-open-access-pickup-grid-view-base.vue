<template>
<div class='view-container depickupgridview pay-open-access-pickup-grid-view'>
...
export default class PayOpenAccessPickupGridViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.payopenaccess.views.pickupgridview.caption',
        srfTitle: 'entities.payopenaccess.views.pickupgridview.title',
        srfSubTitle: 'entities.payopenaccess.views.pickupgridview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'pay-open-access-pickup-grid-view',tag:this.viewtag,srfkey:isNew ? null : this.context.payopenaccess,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'pay-open-access-pickup-grid-view',tag:this.viewtag,srfkey:this.context.payopenaccess,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'pay-open-access-pickup-grid-view')){
                return;
            }
...
<style lang='less'>
@import './pay-open-access-pickup-grid-view.less';
</style>