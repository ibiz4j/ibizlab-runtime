<template>
    <i-form :model="this.data" class='app-form' ref='form'  id='paytrade_main' style="" @on-validate="formItemValidate">
...
export default class MainBase extends Vue implements ControlInterface {
     ...
     * @memberof MainBase
     */
    public majorMessageField: string = "tradename";
...
, 
    ...
    public afterCreated(){
        if(this.isautoload){
            this.autoLoad({srfkey:this.context.paytrade});
        }
        if (this.viewState) {
