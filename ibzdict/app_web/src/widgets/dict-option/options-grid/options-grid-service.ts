...
import OptionsModel from './options-grid-model';
 ...
 */
export default class OptionsService extends ControlService {
     ...
     */
    public appEntityService: DictOptionService = new DictOptionService({ $store: this.getStore() });
     ...
     * @memberof OptionsService
     */
    public dictcatalogService: DictCatalogService = new DictCatalogService();
    ...
    public handleWFData(data:any, isMerge:boolean = false){
        ...
        //补充工作流所需主键
        requestData.srfkey = data.dictoption;
        //补充全量数据
