...
, 
     ...
     * @memberof DefaultBase
     */
    @Watch('data.n_val_like')
    onN_val_likeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_val_like', newVal: newVal, oldVal: oldVal });
    }

    /**
     * 监控表单属性 n_label_like 值
     *
     * @param {*} newVal
     * @param {*} oldVal
     * @memberof DefaultBase
     */
    @Watch('data.n_label_like')
    onN_label_likeChange(newVal: any, oldVal: any) {
        this.formDataChange({ name: 'n_label_like', newVal: newVal, oldVal: oldVal });
    }
