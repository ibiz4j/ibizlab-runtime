<template>
<div class="view-container deeditview dict-catalog-edit-view">
    <app-studioaction :viewTitle="$t(model.srfCaption)" viewName="dictcatalogeditview"></app-studioaction>
    ...
    <div class='toolbar-container'>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem3.visabled" :disabled="toolBarModels.tbitem3.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem3' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem3.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem3.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem4.visabled" :disabled="toolBarModels.tbitem4.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem4' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem4.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem4.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem5.visabled" :disabled="toolBarModels.tbitem5.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem5' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem5.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem5.tip')}}</div>
        </tooltip>
        ...
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem7.visabled" :disabled="toolBarModels.tbitem7.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem7' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem7.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem7.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem12.visabled" :disabled="toolBarModels.tbitem12.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem12' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem12.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem12.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem14.visabled" :disabled="toolBarModels.tbitem14.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem14' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem14.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem14.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>
        <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem23.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem24.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem25.tip')}}</div>
        </tooltip>
        <tooltip :transfer="true" :max-width="600">
            ...
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem26.tip')}}</div>
        </tooltip>
        <span class='seperator'>|</span>
        <tooltip :transfer="true" :max-width="600">
                <i-button v-show="toolBarModels.tbitem22.visabled" :disabled="toolBarModels.tbitem22.disabled" class='' v-loading:i-button @click="toolbar_click({ tag: 'tbitem22' }, $event)">
                    ...
                    <span class='caption'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem22.caption')}}</span>
                </i-button>
            <div slot='content'>{{$t('entities.dictcatalog.editviewtoolbar_toolbar.tbitem22.tip')}}</div>
        </tooltip>
    </div>
</div>
...
export default class DictCatalogEditViewBase extends Vue {
     ...
     */
    public model: any = {
        srfCaption: 'entities.dictcatalog.views.editview.caption',
        srfTitle: 'entities.dictcatalog.views.editview.title',
        srfSubTitle: 'entities.dictcatalog.views.editview.subtitle',
        dataInfo: ''
    }
   ...
   */
    ...
    public parseViewParam(inputvalue:any = null): void {
        ...
        if(inputvalue){
            Object.assign(this.context,{'dictcatalog':inputvalue});
        }
        //初始化视图唯一标识
    ...
    public initNavDataWithRoute(data:any = null, isNew:boolean = false,  isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && Object.is(this.navModel,"route")) ){
            this.navDataService.addNavData({id:'dict-catalog-edit-view',tag:this.viewtag,srfkey:isNew ? null : this.context.dictcatalog,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath});
        }
    }
    ...
    public initNavDataWithTab(data:any = null,isOnlyAdd:boolean = true, isAlways:boolean = false){
        if( isAlways || (this.viewDefaultUsage && !Object.is(this.navModel,"route")) ){
            this.navDataService.addNavDataByOnly({id:'dict-catalog-edit-view',tag:this.viewtag,srfkey:this.context.dictcatalog,title:this.$t(this.model.srfCaption),data:data,context:this.context,viewparams:this.viewparams,path:this.$route.fullPath},isOnlyAdd);
        }
    }
    ...
    public afterCreated(){
        ...
        _this.serviceStateEvent = _this.navDataService.serviceState.subscribe(({ action,name, data }:{ action:string,name:any,data:any }) => {
            if(!Object.is(name,'dict-catalog-edit-view')){
                return;
            }
        ...
        if(_this.portletState){
            _this.portletStateEvent = _this.portletState.subscribe((res:any) =>{
                if(!Object.is(res.name,'DictCatalogEditView')){
                    return;
                }
    ...
    public toolbar_tbitem3_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Save(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem4_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndNew(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem5_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndExit(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem7_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.RemoveAndExit(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem9_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.SaveAndStart(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem10_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.ViewWFStep(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem12_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.New(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem14_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Copy(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem15_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.Print(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem23_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.FirstRecord(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem24_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.PrevRecord(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem25_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.NextRecord(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public toolbar_tbitem26_click(params: any = {}, tag?: any, $event?: any) {
        ...
        // 界面行为
        this.LastRecord(datas, contextJO,paramJO,  $event, xData,this,"DictCatalog");
    }
    ...
    public FirstRecord(args: any[],contextJO?:any, params?: any, $event?: any, xData?: any,actionContext?:any,srfParentDeName?:string) {
        ...
        let allNavData:any = Object.is(this.navModel,"route")?navDataService.getPreNavDataById('dict-catalog-edit-view'):navDataService.getPreNavDataByTag(_this.viewtag);
...
<style lang='less'>
@import './dict-catalog-edit-view.less';
</style>